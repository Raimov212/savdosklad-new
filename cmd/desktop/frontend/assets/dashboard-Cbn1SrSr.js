import{a as e,c as t,d as n,f as r,i,l as a,m as o,n as s,o as c,p as l,r as u,s as d,t as f,u as p}from"./api-CkWzOOJ-.js";window.businessPage=1;var m=[],h=[];async function g(){let e=document.getElementById(`page-content`);try{h=await s.get(`/businesses/my`)||[],_(h)}catch(t){e.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(t.message)}</p></div>`}}function _(e){e&&(m=e,window.businessPage=1);let t=Math.ceil(m.length/10);window.businessPage>t&&(window.businessPage=t||1);let n=(window.businessPage-1)*10,r=m.slice(n,n+10),a=document.getElementById(`page-content`);a.innerHTML=`
  ...
  `,!0),await E(e)};async function E(e){let t=document.getElementById(`cashback-tiers-list`);try{let n=await s.getCashbackTiers(e);if(!n||n.length===0){t.innerHTML=`
    ...
    `}catch(e){t.innerHTML=`<div style="color:#ef4444; padding:16px;">${u(e.message)}</div>`}}window.addCashbackTierUI=function(e){let t=prompt(o(`Minimal harid summasi`));if(t===null)return;let n=prompt(o(`Keshbek foizi`)+` (%)`);n!==null&&s.createCashbackTier({businessId:e,minAmount:parseFloat(t),percentage:parseFloat(n)}).then(()=>{a(o(`Saqlandi`)),E(e)}).catch(e=>a(e.message,`error`))},window.deleteCashbackTier=function(e,t){confirm(o(`O'chirishni xohlaysizmi?`))&&s.deleteCashbackTier(t).then(()=>{a(o(`O'chirildi`)),E(e)}).catch(e=>a(e.message,`error`))},window.togglePointsSettings=function(e){let t=document.getElementById(`points-settings-group`);t&&(t.style.display=e?`flex`:`none`)},window.categoryPage=1;var D=[],O=[];async function te(){let e=document.getElementById(`page-content`),t=d();if(!t){e.innerHTML=`<div class="empty-state"><div class="icon">📂</div><h4>${o(`Avval biznes tanlang`)}</h4></div>`;return}try{O=await s.get(`/categories?businessId=${t}`)||[],re(O)}catch(t){e.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(t.message)}</p></div>`}}function ne(e){return e?new Date(e).toLocaleDateString():``}function re(e){e&&(D=e,window.categoryPage=1);let t=Math.ceil(D.length/10);window.categoryPage>t&&(window.categoryPage=t||1);let n=(window.categoryPage-1)*10,r=D.slice(n,n+10),i=document.getElementById(`page-content`);i.innerHTML=`
      <div class="card">
        <div class="card-header">
    ...
    `}function ie(e){let t=(e||``).toLowerCase(),n=O.filter(e=>e.name&&String(e.name).toLowerCase().includes(t)),r=document.getElementById(`category-search`),i=r?r.selectionStart:0;re(n),setTimeout(()=>{let e=document.getElementById(`category-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}function ae(e=null){let t=!!e;openModal(`
    <div class="modal-header">
  ...
  `),setTimeout(xe,300)}function be(e){let t={"prod-name":e.name,"prod-price":e.price,"prod-buy-price":e.buyPrice||e.buy_price,"prod-cat":e.categoryId||e.category_id,"prod-country":e.country,"prod-short":e.shortDescription||e.short_description,"prod-lcode":e.lokalCode||e.lokal_code};for(let e in t){let n=document.getElementById(e);n&&t[e]!==void 0&&t[e]!==null&&(n.value=t[e])}if(e.images||e.image_url){let t=e.images||e.image_url;document.getElementById(`prod-image-url`).value=t,document.getElementById(`prod-image-preview`).innerHTML=`<img src="${t}" style="width:100%; height:100%; object-fit:cover; border-radius:8px;">`}}window.executeBarcodeLookup=async function(e){let t=(e||``).trim().replace(/\D/g,``);if(t.length<8){a(o(`Shtrix-kod juda qisqa`),`warning`);return}let n=document.getElementById(`prod-name`),r=document.getElementById(`prod-country`),i=document.getElementById(`prod-short`),s=document.getElementById(`prod-image-url`),c=k.find(e=>e.barcode===t);if(c){be(c),a(o(`Ma'lumotlar topildi va to'ldirildi`),`success`);return}a(o(`Global bazadan qidirilmoqda...`),`info`);try{let e=!1,c=null,l=``;for(let n of[`world.openfoodfacts.org`,`world.openproductsfacts.org`,`world.openbeautyfacts.org`]){if(e)break;try{let r=await fetch(`https://${n}/api/v0/product/${t}.json`,{method:`GET`,headers:{Accept:`application/json`},cache:`no-store`});if(r.ok){let t=await r.json();if(t.status===1&&t.product)c=t.product,e=!0,l=n;else if(t.status_verbose&&t.status_verbose.includes(`different product type`))continue}}catch(e){console.warn(`${n} fetch error:`,e)}}if(e&&c){let e=c,t=e.product_name_uz||e.product_name_ru||e.product_name||e.product_name_en||e.generic_name||``;if(n&&!n.value&&t&&(n.value=t),r&&!r.value){let t=e.countries_uz||e.countries_ru||e.countries||``;t&&(r.value=t)}if(i&&!i.value&&(i.value=e.generic_name||e.ingredients_text||e.categories||``),s&&!s.value){let t=e.image_url||e.image_front_url||e.image_small_url;if(t){t.startsWith(`http`)||(t=`https://images.${l.split(`.`).slice(1).join(`.`)}${t}`),s.value=t;let e=document.getElementById(`prod-image-preview`);e&&(e.innerHTML=`<img src="${t}" style="width:100%; height:100%; object-fit:cover; border-radius:8px;">`)}}a(o(`Ma'lumotlar olindi`),`success`)}else a(o(`Mahsulot topilmadi`),`warning`)}catch(e){console.error(`Global lookup failed`,e),a(o(`Global bazaga ulanishda xatolik`),`danger`)}};async function xe(){let e=document.getElementById(`prod-barcode`);if(!e)return;let t=null,n=e=>{let n=e.target.value;t&&clearTimeout(t),t=setTimeout(()=>window.executeBarcodeLookup(n),600)};e.addEventListener(`input`,n),e.addEventListener(`change`,n)}async function Se(){let e=d();try{let t=s.getToken();window.location.href=`${f}/excel/products/export?businessId=${e}&token=${t}`,a(o(`Excel fayl tayyorlanmoqda...`))}catch(e){a(e.message,`error`)}}async function Ce(e){e.preventDefault();let t=d();try{let e=s.getToken();window.location.href=`${f}/excel/products/template?businessId=${t}&token=${e}`,a(o(`Shablon yuklab olinmoqda...`))}catch(e){a(e.message,`error`)}}async function we(e){if(!e.files||e.files.length===0)return;let t=d(),n=e.files[0],r=new FormData;r.append(`businessId`,t),r.append(`file`,n);try{a(o(`Import qilinmoqda...`),`info`);let e=s.getToken(),t=await fetch(`${f}/excel/products/import`,{method:`POST`,headers:{Authorization:`Bearer `+e},body:r}),n=await t.json();if(t.ok){closeModal();let e=(n.created||0)+(n.updated||0)+(n.skipped||0),t=n.errors&&n.errors.length>0,r=t?`
      ...
      `;document.body.insertAdjacentHTML(`beforeend`,i),he()}else throw Error(n.error||o(`Importda xatolik`))}catch(e){a(e.message,`error`)}finally{e.value=``}}async function Te(e,t){e.preventDefault();let n=d(),r=document.getElementById(`prod-image-url`).value,i=document.getElementById(`prod-image`);if(i.files.length>0)try{let e=new FormData;e.append(`file`,i.files[0]);let t=s.getToken(),n=await(await fetch(f.replace(`/api/v1`,``)+`/api/v1/upload`,{method:`POST`,headers:{Authorization:`Bearer `+t},body:e})).json();if(n.url)r=n.url;else throw Error(n.error||`Upload xatolik`)}catch(e){a(`Rasm yuklashda xatolik: `+e.message,`error`);return}try{t?(await s.put(`/products/${t}`,{name:document.getElementById(`prod-name`).value.trim(),lokalCode:document.getElementById(`prod-lcode`).value.trim()||null,shortDescription:document.getElementById(`prod-short`).value.trim(),price:parseFloat(document.getElementById(`prod-price`).value),buyPrice:parseFloat(document.getElementById(`prod-buy-price`).value)||0,discount:parseFloat(document.getElementById(`prod-discount`).value)||0,quantity:parseInt(document.getElementById(`prod-qty`).value),barcode:document.getElementById(`prod-barcode`).value.trim()||null,country:document.getElementById(`prod-country`).value.trim()||null,categoryId:parseInt(document.getElementById(`prod-cat`).value),images:r||null,cashbackPercentage:parseFloat(document.getElementById(`prod-cashback-pct`)?.value)||0}),a(o(`Mahsulot yangilandi`)),closeModal()):(await s.post(`/products`,{businessId:n,name:document.getElementById(`prod-name`).value.trim(),lokalCode:document.getElementById(`prod-lcode`).value.trim()||null,shortDescription:document.getElementById(`prod-short`).value.trim(),price:parseFloat(document.getElementById(`prod-price`).value),buyPrice:parseFloat(document.getElementById(`prod-buy-price`).value)||0,discount:parseFloat(document.getElementById(`prod-discount`).value)||0,quantity:parseInt(document.getElementById(`prod-qty`).value),barcode:document.getElementById(`prod-barcode`).value.trim(),country:document.getElementById(`prod-country`).value.trim(),categoryId:parseInt(document.getElementById(`prod-cat`).value),images:r,cashbackPercentage:parseFloat(document.getElementById(`prod-cashback-pct`)?.value)||0}),a(o(`Mahsulot yaratildi`)),De()),he()}catch(e){a(e.message,`error`)}}async function Ee(e){if(confirm(o(`Mahsulotni o'chirishga ishonchingiz komilmi?`)))try{await s.delete(`/products/${e}`),a(o(`Mahsulot o'chirildi`)),he()}catch(e){a(e.message,`error`)}}function De(){[`prod-name`,`prod-cat`,`prod-barcode`,`prod-price`,`prod-discount`,`prod-qty`,`prod-country`,`prod-lcode`,`prod-short`,`prod-image-url`].forEach(e=>{let t=document.getElementById(e);t&&(t.value=e===`prod-discount`?`0`:``)});let e=document.getElementById(`prod-image-preview`);e&&(e.innerHTML=`<span style="font-size:32px; opacity:0.3;">🖼️</span>`);let t=document.getElementById(`prod-image`);t&&(t.value=``),a(o(`Forma tozalandi`))}function Oe(){me=!me,_e(me?k.filter(e=>(e.quantity||0)<=0):k),setTimeout(()=>{let e=document.getElementById(`out-of-stock-btn`);e&&(me?(e.style.background=`var(--danger)`,e.style.color=`#fff`,e.style.borderColor=`var(--danger)`):(e.style.background=``,e.style.color=``,e.style.borderColor=``))},50)}window.resetProductForm=De,window.renderProducts=he,window.renderProductsTable=_e,window.filterProducts=ve,window.openProductModal=ye,window.saveProduct=Te,window.deleteProduct=Ee,window.handleProductExport=Se,window.handleProductImport=we,window.handleProductTemplate=Ce,window.toggleOutOfStockFilter=Oe,window.productPage=productPage,window.allProducts=k,window.allCategories=pe,window.currentProducts=ge,window.clientPage=1;var ke=[],A=[];async function Ae(){let e=document.getElementById(`page-content`),t=d();try{if(t)A=await s.get(`/clients?businessId=${t}`)||[];else{let t=await s.get(`/businesses/my`).catch(()=>[]);if(!t||t.length===0){e.innerHTML=`<div class="empty-state"><div class="icon">🏢</div><h4>${o(`Biznes yarating`)}</h4></div>`;return}A=(await Promise.all((t||[]).filter(e=>e).map(e=>s.get(`/clients?businessId=${e.id}`).catch(()=>[]).then(t=>((t||[]).filter(e=>e).forEach(t=>{t._businessName=e.name,t._businessId=e.id}),(t||[]).filter(e=>e)))))).flat().filter(e=>e)}je(A)}catch(t){e.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(t.message)}</p></div>`}}function je(e,t=!1){typeof e==`boolean`&&(t=e,e=null),e&&(ke=e,t||(window.clientPage=1));let n=Math.ceil(ke.length/15),r=window.clientPage*15,i=ke.slice(r-15,r),a=document.getElementById(`page-content`),s=[`acc-avatar-indigo`,`acc-avatar-green`,`acc-avatar-blue`,`acc-avatar-orange`],l=i.length===0&&!t?`<div class="empty-state"><div class="icon">👥</div><h4>${o(`Mijozlar yo'q`)}</h4></div>`:i.map((e,t)=>{let n=s[t%s.length],r=(e.fullName||`?`)[0].toUpperCase(),i=e._businessName?`<span class="badge" style="background:rgba(255,255,255,0.05); border:1px solid var(--border); font-size:10px; opacity:0.7; margin-left:8px;">${u(e._businessName)}</span>`:``;return`
    ...
    `,attachInfiniteScroll(`clientPage`,n,`renderClientsTable`);else{let e=document.getElementById(`client-acc-list`);e&&e.insertAdjacentHTML(`beforeend`,l);let t=document.getElementById(`client-pagination-area`);t&&(t.innerHTML=renderPageControls(`clientPage`,n,`renderClientsTable`)),attachInfiniteScroll(`clientPage`,n,`renderClientsTable`)}}function Me(e){let t=(e||``).toLowerCase(),n=A.filter(e=>e.fullName&&String(e.fullName).toLowerCase().includes(t)||e.phone&&String(e.phone).toLowerCase().includes(t)),r=document.getElementById(`client-search`),i=r?r.selectionStart:0;je(n),setTimeout(()=>{let e=document.getElementById(`client-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}function Ne(e=null){let t=!!e;openModal(`
    <div class="modal-header">
  ...
  `)}async function Pe(e,t){e.preventDefault();let n=d(),r=document.getElementById(`client-name`).value.trim(),i=document.getElementById(`client-phone`).value.trim(),c=document.getElementById(`client-address`).value.trim()||null;if(i.startsWith(`+998`)){if(!/^\+998\d{9}$/.test(i)){a(o(`Telefon raqami noto'g'ri (+998XXXXXXXXX ko'rinishida bo'lsin)`),`error`);return}}else if(!i.startsWith(`+`)){a(o(`Telefon raqami '+' bilan boshlanishi kerak`),`error`);return}let l=s.getUser();if(l&&(l.phone===i||l.phoneNumber===i)){a(o(`O'zingizni mijoz sifatida qo'sha olmaysiz`),`error`);return}try{t?(await s.put(`/clients/${t}`,{businessId:n||0,fullName:r,phone:i,address:c}),a(o(`Mijoz yangilandi`)),closeModal()):(await s.post(`/clients`,{businessId:n,fullName:r,phone:i,address:c}),a(o(`Mijoz qo'shildi`)),document.getElementById(`client-name`).value=``,document.getElementById(`client-phone`).value=``,document.getElementById(`client-address`).value=``,document.getElementById(`client-name`).focus()),Ae()}catch(e){a(e.message,`error`)}}async function Fe(e){if(confirm(o(`Mijozni o'chirishga ishonchingiz komilmi?`)))try{let t=d();await s.delete(`/clients/${e}${t?`?businessId=`+t:``}`),a(o(`Mijoz o'chirildi`)),Ae()}catch(e){a(e.message,`error`)}}window.toggleClientTransAcc=async function(e,t){p(`client-trans-acc-`+e);let n=document.getElementById(`client-trans-items-`+e);if(n&&!n.dataset.loaded){n.innerHTML=`<div class="loader" style="width:20px;height:20px;margin:10px auto;"></div>`;try{Array.isArray(t)||(t=[t]);let e=t.map(e=>s.get(`/transactions/${e}/items`)),r=(await Promise.all(e)).flat();if(r.length===0){n.innerHTML=`<div style="text-align:center; padding:10px; color:var(--text-muted); font-size:12px;">${o(`Ma'lumot yo'q`)}</div>`,n.dataset.loaded=`true`;return}let i=`<div style="background:var(--bg-secondary); border-radius:10px; padding:10px; margin-top:10px;">
    ...
    `,attachInfiniteScroll(`transactionPage`,r,`renderTransactionsTable`);else{let e=document.getElementById(`transaction-acc-list`);e&&e.insertAdjacentHTML(`beforeend`,l);let t=document.getElementById(`transaction-pagination-area`);t&&(t.innerHTML=renderPageControls(`transactionPage`,r,`renderTransactionsTable`)),attachInfiniteScroll(`transactionPage`,r,`renderTransactionsTable`)}}function qe(e){let t=(e||``).toLowerCase(),n=Ue.filter(e=>e.clientNumber&&String(e.clientNumber).toLowerCase().includes(t)||e.clientName&&String(e.clientName).toLowerCase().includes(t)),r=document.getElementById(`transaction-search`),i=r?r.selectionStart:0;Ke(n),setTimeout(()=>{let e=document.getElementById(`transaction-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}async function Je(e){if(!confirm(o(`Haqiqatan ham bu sotuvni o'chirmoqchimisiz? Bu mahsulotlarni omborga qaytaradi.`)))return;let t=d();try{a(o(`O'chirilmoqda...`),`info`),await s.delete(`/transactions/${e}?businessId=${t}`),a(o(`Muvaffaqiyatli o'chirildi`)),Ge()}catch(e){a(e.message,`error`)}}async function Ye(){d();try{let e=await s.get(`/businesses/my`).catch(()=>[])||[],[t,n]=await Promise.all([s.get(`/products/my`),Promise.all((e||[]).filter(e=>e).map(e=>s.get(`/clients?businessId=${e.id}`).catch(()=>[])))]),r=n.flat().filter(e=>e),i=new Map;r.forEach(e=>i.set(e.id,e));let a=Array.from(i.values());M=(t||[]).filter(e=>e&&!e.isDeleted&&e.quantity>0).map(t=>{let n=(e||[]).find(e=>e&&e.id===t.businessId);return{...t,businessName:n?n.name:o(`Noma'lum`)}}),We=a||[],P=null,F=[],I={cash:0,card:0,click:0,debt:0},N=[],openModal(`
      <div class="modal-header">
    ...
    `).join(``),t.style.display=`block`},window.selectSaleClient=function(e){let t=We.find(t=>t.id==e);if(!t)return;let n=document.getElementById(`sale-client-search`);n&&(n.value=t.fullName);let r=document.getElementById(`sale-client-id`);r&&(r.value=e);let i=document.getElementById(`sale-client-results`);i&&(i.style.display=`none`),window.onSaleClientChange(e)};function Ze(e){let t=M.find(t=>t.id===e);if(!t)return;let n=N.find(t=>t.productId==e);if((n?n.quantity+1:1)>t.quantity){a(o(`Sotuvda yetarli mahsulot qoldig'i mavjud emas!`),`warning`);return}if(n)n.quantity++;else{let n=t.discount>0?t.price*(1-t.discount/100):t.price;N.push({productId:e,quantity:1,price:n,name:t.name,businessId:t.businessId,businessName:t.businessName})}let r=document.getElementById(`sale-product-search`);r.value=``,document.getElementById(`sale-search-results`).style.display=`none`,r.focus(),L()}function L(){let e=document.getElementById(`sale-items-container`);if(e){if(N.length===0){e.innerHTML=`
    ...
    </div > `,R()}}function Qe(e){N.splice(e,1),L()}function $e(e,t){let n=parseInt(t)||1,r=N[e].productId,i=M.find(e=>e.id===r);if(i&&n>i.quantity){a(`${o(`Zaxirada atigi`)} ${i.quantity} ${o(`dona mavjud`)}`,`warning`),N[e].quantity=i.quantity,L(),R();return}N[e].quantity=n;let s=N[e].price*n,l=document.getElementById(`item-total-${e}`);l&&(l.textContent=c(s)),R()}function et(e,t){let n=parseFloat(t)||0;N[e].price=n;let r=n*N[e].quantity,i=document.getElementById(`item-total-${e}`);i&&(i.textContent=c(r)),R()}function R(){let e=N.reduce((e,t)=>e+parseInt(t.quantity||0),0)+F.reduce((e,t)=>e+parseInt(t.quantity||0),0),t=N.reduce((e,t)=>e+t.price*t.quantity,0),n=document.getElementById(`sale-total-qty-mini`);n&&(n.textContent=`${e} ${o(`ta`)}`);let r=document.getElementById(`sale-total-mini`);r&&(r.textContent=`${c(t)} ${o(`so'm`)}`);let i=document.getElementById(`sale-total-value`);i&&(i.textContent=`${c(t+F.reduce((e,t)=>e+t.price*t.quantity,0))} ${o(`so'm`)}`),z()}function z(){let e=N.reduce((e,t)=>e+t.price*t.quantity,0)+F.reduce((e,t)=>e+t.price*t.quantity,0),t=document.getElementById(`sale-cash`),n=document.getElementById(`sale-card`),r=document.getElementById(`sale-click`);if(!t)return;let i=parseFloat(t.value)||0,a=parseFloat(n.value)||0,s=parseFloat(r.value)||0,l=parseFloat(document.getElementById(`sale-cashback-used`)?.value||0)||0,u=parseFloat(document.getElementById(`sale-points-used`)?.value||0)||0,d=parseFloat(document.getElementById(`sale-discount`)?.value||0)||0,f=I.cash+I.card+I.click,p=f+(i+a+s+l+u),m=document.getElementById(`sale-debt`),h=document.getElementById(`payment-error-msg`),g=document.getElementById(`breakdown-subtotal`),_=document.getElementById(`breakdown-discount`),v=document.getElementById(`breakdown-cashback-row`),y=document.getElementById(`breakdown-cashback`),b=document.getElementById(`breakdown-points-row`),x=document.getElementById(`breakdown-points`),S=document.getElementById(`breakdown-payable`),C=document.getElementById(`breakdown-paid`),w=document.getElementById(`breakdown-remaining`);document.getElementById(`breakdown-remaining-row`),g&&(g.textContent=`${c(e)} ${o(`so'm`)}`),_&&(_.textContent=`- ${c(d)} ${o(`so'm`)}`),l>0?(v&&(v.style.display=`flex`),y&&(y.textContent=`- ${c(l)} ${o(`so'm`)}`)):v&&(v.style.display=`none`),u>0?(b&&(b.style.display=`flex`),x&&(x.textContent=`- ${c(u)} ${o(`so'm`)}`)):b&&(b.style.display=`none`);let T=e-d,ee=T-l-u;S&&(S.textContent=`${c(Math.max(0,ee))} ${o(`so'm`)}`);let E=i+a+s+f;C&&(C.textContent=`${c(E)} ${o(`so'm`)}`);let D=ee-E;w&&(w.textContent=`${c(Math.max(0,D))} ${o(`so'm`)}`,D<=0?w.style.color=`var(--success)`:w.style.color=`var(--primary)`),p>T+.01?(S&&(S.style.color=`#EF4444`),m.style.color=`#EF4444`,h&&(h.style.display=`block`)):(S&&(S.style.color=`var(--primary)`),m.style.color=`var(--warning)`,h&&(h.style.display=`none`)),T-p,m&&(m.value=Math.max(0,D)),window.updatePointsEarnedPreview&&window.updatePointsEarnedPreview()}async function tt(){d();let e=N.filter(e=>e.productId);if(e.length===0){a(o(`Kamida bitta mahsulot tanlang`),`warning`);return}try{let t=d();if(!t&&e.length>0&&(t=e[0].businessId),!t){a(o(`Iltimos, avval biznesni tanlang`),`error`);return}let n=e.reduce((e,t)=>e+t.price*t.quantity,0),r=document.getElementById(`sale-client-id`).value,i=parseFloat(document.getElementById(`sale-cash`).value)||0,c=parseFloat(document.getElementById(`sale-card`).value)||0,l=parseFloat(document.getElementById(`sale-click`).value)||0,u=parseFloat(document.getElementById(`sale-debt`).value)||0,f=e.reduce((e,t)=>e+t.price*t.quantity,0)+F.reduce((e,t)=>e+t.price*t.quantity,0);if(I.cash+I.card+I.click+(i+c+l)>f){a(o(`"JAMI" dan katta summani kirita olmaysiz!`),`error`);let e=document.getElementById(`sale-total-value`);e&&(e.classList.add(`shake`),setTimeout(()=>e.classList.remove(`shake`),500));return}P?(await s.post(`/transactions/${P}/items?businessId=${t}`,e.map(e=>({productId:parseInt(e.productId),productQuantity:e.quantity,productPrice:e.price,businessId:e.businessId}))),I.cash+=i,I.card+=c,I.click+=l,I.debt+=u):(P=(await s.post(`/transactions`,{businessId:t,total:n,cash:i,card:c,click:l,debt:u,clientId:r?parseInt(r):null,description:document.getElementById(`sale-desc`).value.trim(),items:e.map(e=>({productId:parseInt(e.productId),productQuantity:e.quantity,productPrice:e.price,businessId:e.businessId}))})).id,I.cash=i,I.card=c,I.click=l,I.debt=u),F=[...F,...e],N=[],document.getElementById(`sale-cash`).value=0,document.getElementById(`sale-card`).value=0,document.getElementById(`sale-click`).value=0,L(),nt(),a(o(`Xarid saqlandi`),`success`)}catch(e){a(e.message,`error`)}}function nt(){let e=document.getElementById(`sale-batches-container`);if(!e)return;if(F.length===0){e.innerHTML=``;return}e.innerHTML=`
  ...
  `;let t=document.getElementById(`cumulative-total`);if(t){let e=F.reduce((e,t)=>e+t.price*t.quantity,0);t.textContent=`${o(`Avval saqlangan`)}: ${c(e)} ${o(`so'm`)}`}}async function rt(e){e&&e.preventDefault();let t=parseFloat(document.getElementById(`sale-cash`).value)||0,n=parseFloat(document.getElementById(`sale-card`).value)||0,r=parseFloat(document.getElementById(`sale-click`).value)||0,i=parseFloat(document.getElementById(`sale-discount`).value)||0,c=N.reduce((e,t)=>e+t.price*t.quantity,0)+F.reduce((e,t)=>e+t.price*t.quantity,0),l=c-i,u=I.cash+I.card+I.click;if(u+t+n+r>l+.01){a(o(`"JAMI" dan katta summani kirita olmaysiz!`),`error`);return}try{a(o(`Yakunlanmoqda...`),`info`);let e=d();if(e||(N.length>0?e=N[0].businessId:F.length>0&&(e=F[0].businessId)),!e){a(o(`Iltimos, avval biznesni tanlang`),`error`);return}let f=document.getElementById(`sale-client-id`).value,p=document.getElementById(`sale-desc`).value.trim(),m=parseFloat(document.getElementById(`sale-cashback-used`)?.value||0)||0,h=parseFloat(document.getElementById(`sale-points-used`)?.value||0)||0,g=Math.max(0,l-(u+t+n+r+m+h));if(P?(N.length>0&&await s.post(`/transactions/${P}/items?businessId=${e}`,N.map(e=>({productId:parseInt(e.productId),productQuantity:e.quantity,productPrice:e.price,businessId:e.businessId}))),await s.put(`/transactions/${P}`,{total:c,cash:I.cash+t,card:I.card+n,click:I.click+r,debt:g,discount:i,usePointsAmount:h,clientId:f?parseInt(f):null,description:p})):P=(await s.post(`/transactions`,{businessId:e,total:c,cash:t,card:n,click:r,debt:g,discount:i,useCashbackAmount:m,usePointsAmount:h,clientId:f?parseInt(f):null,description:p,items:N.map(e=>({productId:parseInt(e.productId),productQuantity:e.quantity,productPrice:e.price,businessId:e.businessId}))})).id,a(o(`Sotuv muvaffaqiyatli yakunlandi!`),`success`),N=[],F=[],P=null,I={cash:0,card:0,click:0,debt:0},document.getElementById(`sale-step-1`)){document.getElementById(`sale-step-1`).style.display=`block`,document.getElementById(`sale-step-2`).style.display=`none`,document.getElementById(`step-1-indicator`).classList.add(`active`),document.getElementById(`step-2-indicator`).classList.remove(`active`);let e=document.getElementById(`sale-cash`),t=document.getElementById(`sale-card`),n=document.getElementById(`sale-click`);e&&(e.value=0),t&&(t.value=0),n&&(n.value=0);let r=document.getElementById(`sale-discount`);r&&(r.value=0);let i=document.getElementById(`sale-client-search`);i&&(i.value=``);let a=document.getElementById(`sale-client-id`);a&&(a.value=``);let o=document.getElementById(`sale-desc`);o&&(o.value=``),L(),R();let s=document.getElementById(`sale-product-search`);s&&(s.value=``,s.focus())}else closeModal();Ge()}catch(e){a(e.message,`error`)}}async function it(e){Array.isArray(e)||(e=[e]);try{a(o(`Tafsilotlar yuklanmoqda...`),`info`);let t=d(),n=await Promise.all(e.map(e=>s.get(`/transactions/${e}?businessId=${t}`))),r=(await Promise.all(e.map(e=>s.get(`/transactions/${e}/items?businessId=${t}`)))).filter(e=>e!==null).flat(),i=n.reduce((e,t)=>e+(t.cashbackUsed||0),0),l=n.reduce((e,t)=>e+(t.pointsUsed||0),0),f=n.reduce((e,t)=>e+(t.pointsEarned||0),0),p=n.reduce((e,t)=>e+(t.cashbackEarned||0),0),m=n.reduce((e,t)=>e+(t.discount||0),0),h=r.reduce((e,t)=>e+(t.productPrice||0)*(t.productQuantity||0),0);openModal(`
      <div class="modal-header">
    ...
    `)}catch(e){a(e.message,`error`)}}async function at(e,t){try{let n=await s.get(`/transactions/items/${e}`);if(!n)return;let r=prompt(o(`Yangi miqdorni kiriting:`),n.productQuantity);if(r===null)return;let i=prompt(o(`Yangi narxni kiriting:`),n.productPrice);if(i===null)return;await s.put(`/transactions/items/${e}`,{productQuantity:parseInt(r),productPrice:parseFloat(i)}),a(o(`Muvaffaqiyatli yangilandi`),`success`),it(t),Ge()}catch(e){a(e.message,`error`)}}window.editTransactionItem=at;async function ot(e,t){if(confirm(o(`Ushbu mahsulotni sotuvdan o'chirishni tasdiqlaysizmi?`)))try{await s.delete(`/transactions/items/${e}`),a(o(`Muvaffaqiyatli o'chirildi`),`success`),it(t),Ge()}catch(e){a(e.message,`error`)}}window.deleteTransactionItem=ot;async function st(t,n=null){Array.isArray(t)||(t=[t]);let{jsPDF:r}=window.jspdf,i=d();try{a(o(`PDF tayyorlanmoqda...`),`info`);let l=await s.get(`/businesses/my`).catch(()=>[]),[u,d]=await Promise.all([Promise.all(t.map(e=>s.get(`/transactions/${e}/items?businessId=${i}`))),Promise.all(l.map(e=>s.get(`/clients?businessId=${e.id}`).catch(()=>[])))]),f=d.flat(),p=u.flat(),m=n||Ue.find(e=>e.id===t[0]),h=new r,g=`helvetica`;try{let e=await fetch(`/fonts/Roboto-Regular.ttf`);if(e.ok){let t=await e.blob(),n=await new Promise(e=>{let n=new FileReader;n.onloadend=()=>e(n.result.split(`,`)[1]),n.readAsDataURL(t)});h.addFileToVFS(`Roboto-Regular.ttf`,n),h.addFont(`Roboto-Regular.ttf`,`Roboto`,`normal`),h.setFont(`Roboto`),g=`Roboto`}}catch{}h.setFont(g),h.setFontSize(11),h.setTextColor(0,0,0);let _=f&&m.clientId?f.find(e=>e.id===m.clientId):null,v=20;if(_)h.text(`${o(`Mijoz`)}: ${_.fullName}`,15,v),v+=6,h.text(`${o(`Manzil`)}: ${_.address||`-`}`,15,v),v+=6,h.text(`${o(`Telefon`)}: ${_.phone||`-`}`,15,v);else{let e=m.clientName||m.clientNumber||o(`Begona xaridor`);h.text(`${o(`Mijoz`)}: ${e}`,10,v),v+=6,h.text(`${o(`Telefon`)}: ${m.clientNumber||`-`}`,10,v)}let y=p.map((e,t)=>{let n=e.productName||`${o(`Mahsulot`)} #${e.productId}`;return[t+1,n,e.productQuantity,c(e.productPrice),c(e.productPrice*e.productQuantity),e.productBarcode||`-`]}),b=p.reduce((e,t)=>e+(t.productQuantity||0),0),x=p.reduce((e,t)=>e+(t.productPrice||0)*(t.productQuantity||0),0);h.autoTable({startY:35,head:[[`№`,o(`Mahsulot nomi`),o(`Soni`),o(`Narxi`),o(`Jami`),o(`Barcode`)]],body:y,foot:[[``,o(`Jami`)+`:`,b,``,c(x),``]],theme:`grid`,headStyles:{fillColor:[230,230,230],textColor:0,fontStyle:`normal`,font:g,halign:`center`},footStyles:{fillColor:[240,240,240],textColor:[239,68,68],fontStyle:`bold`,font:g,halign:`center`},styles:{fontSize:10,textColor:0,font:g,halign:`center`},columnStyles:{0:{cellWidth:10,halign:`center`},2:{cellWidth:20,halign:`center`},3:{cellWidth:30,halign:`right`},4:{cellWidth:35,halign:`right`},5:{cellWidth:30,halign:`right`}}});let S=h.lastAutoTable.finalY+15;return h.setFontSize(11),h.setTextColor(0,0,0),h.text(`${o(`Naqd`)}: ${c(m.cash)}`,15,S),S+=5,h.text(`${o(`Karta`)}: ${c(m.card)}`,15,S),S+=5,h.text(`${o(`Click`)}: ${c(m.click||0)}`,15,S),S+=5,h.text(`${o(`Qarz`)}: ${c(m.debt)}`,15,S),h.setFontSize(8),h.setTextColor(180,180,180),h.text(`${e(m.createdAt)} ${o(`da generatsiya qilindi`)} [IDs: ${t.join(`,`)}]`,10,285),h.setFontSize(11),h.setTextColor(0,0,0),h.text(`${o(`Sotuv tafsilotlari`)} № : ${t.join(`, `)} `,105,10,{align:`center`}),h.text(`Sana : ${e(m.createdAt)} `,105,15,{align:`center`}),h.save(`${o(`Sotuv_`)}${t.join(`_`)}.pdf`),a(o(`PDF yuklab olindi`)),h.output(`blob`)}catch(e){console.error(e),a(o(`PDF yarata olmadim: `)+e.message,`error`)}}async function ct(e){Array.isArray(e)||(e=[e]);let t=e[0];try{let e=document.querySelector(`.modal`);if(!e)return;let n=e.querySelector(`.modal-footer`);n&&(n.style.display=`none`);let r=await html2canvas(e,{backgroundColor:getComputedStyle(document.documentElement).getPropertyValue(`--bg-secondary`),scale:2});n&&(n.style.display=`flex`);let i=document.createElement(`a`);return i.download=`Sotuv_${t}.jpg`,i.href=r.toDataURL(`image/jpeg`,.9),i.click(),a(o(`Rasm yuklab olindi`)),new Promise(e=>r.toBlob(e,`image/jpeg`,.9))}catch(e){a(o(`Rasm yarata olmadim: `)+e.message,`error`)}}async function lt(e){Array.isArray(e)||(e=[e]);try{a(o(`Telegramga yuborilmoqda...`),`info`);let t=await st(e);if(!t)throw Error(`Could not generate receipt files`);let n=new FormData;t&&n.append(`pdf`,t,`Receipt_${e[0]}.pdf`),await s.post(`/transactions/${e[0]}/send-telegram`,n,{headers:{"Content-Type":`multipart/form-data`}}),a(o(`Telegramga yuborildi!`))}catch(e){a(e.message,`error`)}}function ut(e){if(!e)return;let t=M.find(t=>t.barcode===e);t?Ze(t.id):a(o(`Mahsulot topilmadi`),`warning`)}window.addToSaleBatch=tt,window.renderSavedBatches=nt,window.finalizeSale=rt,window.renderTransactions=Ge,window.renderTransactionsTable=Ke,window.filterTransactions=qe,window.openSaleModal=Ye,window.addSaleProductByBarcode=ut,window.searchSaleProduct=Xe,window.addSaleProductById=Ze,window.renderSaleItems=L,window.removeSaleItem=Qe,window.onSaleQtyChange=$e,window.onSalePriceChange=et,window.updateSaleTotal=R,window.updateSalePayment=z,window.viewTransactionItems=it,window.downloadTransactionPdf=st,window.downloadTransactionJpg=ct,window.sendTransactionToTelegram=lt,window.deleteTransaction=Je,window.transactionPage=transactionPage,window.allTransactionsList=Ue,window.currentTransactions=He,window.saleProducts=M,window.saleItems=N,window.onSaleClientChange=function(e){let t=d(),n=document.getElementById(`bonus-section`),r=document.getElementById(`bonus-cards-container`),i=document.getElementById(`sale-cashback-used`),a=document.getElementById(`sale-points-used`);if(i.value=0,a.value=0,n&&(n.style.display=`none`),r&&(r.innerHTML=``),!e){z();return}let l=We.find(t=>t.id==e);if(!l)return;n&&(n.style.display=`block`);let u=l.cashbackBalance||0,f=document.createElement(`div`);f.className=`bonus-card`,f.style=`background:var(--bg-glass); border:1px solid var(--border); border-radius:12px; padding:12px; display:flex; flex-direction:column; gap:8px;`,f.innerHTML=`
    <div style="display:flex; justify-content:space-between; align-items:center;">
  ...
  `,r&&r.appendChild(h);let y=h.querySelector(`#pt-use-check`),b=h.querySelector(`#pt-spend-area`),x=h.querySelector(`#pt-spend-input`),S=h.querySelector(`#btn-pt-spend-all`),C=h.querySelector(`#pt-earn-check`),w=h.querySelector(`#pt-earn-preview`);y.onchange=()=>{b.style.display=y.checked?`block`:`none`,y.checked||(x.value=0,a.value=0,z())},x.oninput=e=>{a.value=Math.min(parseFloat(e.target.value)||0,g*_),z()},S.onclick=()=>{x.value=g*_,a.value=g*_,z()},window.updatePointsEarnedPreview=()=>{if(!C.checked){w.textContent=`0`;return}let e=parseFloat(document.getElementById(`sale-cash`).value)||0,t=parseFloat(document.getElementById(`sale-card`).value)||0,n=parseFloat(document.getElementById(`sale-click`).value)||0;w.textContent=Math.floor((e+t+n)/v)},C.onchange=window.updatePointsEarnedPreview;let T=t;!T&&N.length>0&&(T=N[0].businessId),T&&s.get(`/businesses/${T}`).then(e=>{e&&(_=e.pointValue||100,v=e.pointsRate||1e4,window.updatePointsEarnedPreview&&window.updatePointsEarnedPreview())}),z()},window.refundPage=1;var dt=[],ft=[];async function pt(){let e=document.getElementById(`page-content`),t=d();if(!t){e.innerHTML=`<div class="empty-state"><div class="icon">🔄</div><h4>${o(`Avval biznes tanlang`)}</h4></div>`;return}try{ft=await s.get(`/refunds?businessId=${t}${getDateQuery()}`)||[],mt(ft)}catch(t){e.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(t.message)}</p></div>`}}function mt(t,n=!1){typeof t==`boolean`&&(n=t,t=null),t&&(n||(window.refundPage=1),dt=t);let r=Math.ceil(dt.length/15),i=window.refundPage*15,a=dt.slice(i-15,i),s=document.getElementById(`page-content`),l=a.length===0&&!n?`<div class="empty-state"><div class="icon">🔄</div><h4>${o(`Qaytarishlar yo'q`)}</h4></div>`:a.map((t,n)=>`
    ...
    `,attachInfiniteScroll(`refundPage`,r,`renderRefundsTable`);else{let e=document.getElementById(`refund-acc-list`);e&&e.insertAdjacentHTML(`beforeend`,l);let t=document.getElementById(`refund-pagination-area`);t&&(t.innerHTML=renderPageControls(`refundPage`,r,`renderRefundsTable`)),attachInfiniteScroll(`refundPage`,r,`renderRefundsTable`)}}async function ht(e){try{a(o(`Tafsilotlar yuklanmoqda...`),`info`);let t=d(),n=await s.get(`/refunds/${e}/items?businessId=${t}`)||[];openModal(`
      <div class="modal-header">
  ...
  `)}async function yt(){let e=document.getElementById(`refund-trans-id`).value;if(e)try{a(o(`Tafsilotlar yuklanmoqda...`),`info`);let t=d();if(B=await s.get(`/transactions/${e}/items?businessId=${t}`)||[],B.length===0){document.getElementById(`refund-items-area`).innerHTML=`<p style="color:var(--danger); text-align:center; padding:20px;">${o(`Sotuv topilmadi yoki unda mahsulotlar yo'q`)}</p>`;return}bt()}catch(e){a(e.message,`error`)}}function bt(){let e=document.getElementById(`refund-items-area`);e.innerHTML=`
    <div class="table-container" style="max-height: 380px; overflow-y: auto; margin-bottom: 20px; border: 1px solid var(--border); border-radius: var(--radius-md);">
      <table style="font-size: 12px; width: 100%; border-collapse: collapse;">
        ...
        <tbody>
          ${B.map((e,t)=>{let n=e.productQuantity-(e.refundedQuantity||0),r=n<=0;return`
  ...
  `}function xt(e,t){let n=parseInt(t)||0,r=B[e],i=r.productQuantity-(r.refundedQuantity||0);n>i&&(a(`${o(`Maksimal qaytarish miqdori`)}: ${i}`,`warning`),n=i,document.getElementById(`refund-qty-${e}`).value=n);let s=document.getElementById(`refund-amount-${e}`);s.value=n*r.productPrice,Ct()}function St(e,t){let n=parseFloat(t)||0;parseInt(document.getElementById(`refund-qty(${e})`)?document.getElementById(`refund-qty(${e})`).value:0);let r=document.getElementById(`refund-qty-${e}`),i=(r&&parseInt(r.value)||0)*B[e].productPrice;n>i&&(document.getElementById(`refund-amount-${e}`).value=i,a(o(`Qaytarish summasi sotuv narxidan oshib keta olmaydi`),`warning`)),Ct()}function Ct(){let e=0;B.forEach((t,n)=>{let r=document.getElementById(`refund-amount-${n}`);r&&(e+=parseFloat(r.value)||0)});let t=document.getElementById(`refund-total-amount`);t&&(t.textContent=c(e))}async function wt(){let e=d();document.getElementById(`refund-trans-id`).value;let t=document.getElementById(`refund-desc`).value,n=[],r=0;if(B.forEach((e,i)=>{let a=document.getElementById(`refund-qty-${i}`),o=document.getElementById(`refund-amount-${i}`);if(a&&o){let i=parseInt(a.value)||0,s=parseFloat(o.value)||0;i>0&&(n.push({productId:e.productId,productQuantity:i,productPrice:e.productPrice,transactionId:e.id,description:t}),r+=s)}}),n.length===0||r<=0){openModal(`
      <div class="modal-header">
    ...
    `);return}try{await s.post(`/refunds`,{businessId:e,total:r,description:t,cash:r,items:n}),a(o(`Qaytarish muvaffaqiyatli amalga oshirildi!`));let i=document.getElementById(`refund-trans-id`);i?(i.value=``,document.getElementById(`refund-items-area`).innerHTML=``,i.focus()):closeModal(),pt()}catch(e){a(e.message,`error`)}}window.renderRefunds=pt,window.renderRefundsTable=mt,window.filterRefunds=_t,window.openRefundModal=vt,window.checkTransactionForRefund=yt,window.onRefundQtyChange=xt,window.validateRefundAmount=St,window.updateRefundTotal=Ct,window.submitRefund=wt,window.viewRefundItems=ht,window.downloadRefundPdf=gt,window.refundPage=refundPage,window.activeDebtPage=1,window.paidDebtPage=1;var Tt=[],Et=[],Dt=[];async function Ot(){let e=document.getElementById(`page-content`),t=d();if(!t){e.innerHTML=`<div class="empty-state"><div class="icon">⚠️</div><h4>${o(`Avval biznes tanlang`)}</h4></div>`;return}try{Dt=await s.get(`/transactions?businessId=${t}`)||[],Tt=[],Et=[],Dt.forEach(e=>{e.debt>0?Tt.push(e):(e.debtLimitDate||e.clientId&&new Date(e.updatedAt)>new Date(new Date(e.createdAt).getTime()+1e3))&&Et.push(e)}),kt()}catch(t){e.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(t.message)}</p></div>`}}function kt(){let e=document.getElementById(`page-content`),t=window.currentDebtTab||`active`;e.innerHTML=`
  ...
  `,At(t)}window.filterDebts=function(e){let t=e.toLowerCase();At(window.currentDebtTab||`active`,t)},window.switchDebtTab=function(e){window.currentDebtTab=e,kt()};function At(t,n=``,r=!1){typeof n==`boolean`&&(r=n,n=``);let i=document.getElementById(`debts-table-container`);if(!i)return;let a=t===`active`?`activeDebtPage`:`paidDebtPage`;r||(window[a]=1);let s=getDatePeriod(),l=(t===`active`?Tt:Et).filter(e=>{let t=e.createdAt.substring(0,10);if(!(t>=s.start&&t<=s.end))return!1;let r=(e.clientName||e.clientNumber||o(`Begona xaridor`)).toLowerCase();return!n||r.includes(n)||e.id.toString().includes(n)}),d=Math.ceil(l.length/15),f=window[a]*15,p=l.slice(f-15,f),m=p.length===0&&!r?`<div class="empty-state"><div class="icon">✅</div><h4>${o(t===`active`?`Qarzdorlar topilmadi`:`Hech qanday to'langan qarz yo'q`)}</h4></div>`:p.map((n,r)=>{let i=n.clientName?u(n.clientName):n.clientNumber?u(n.clientNumber):o(`Begona xaridor`);return`
  ...
  `)},window.calcRemainingDebt=function(e){let t=parseFloat(document.getElementById(`pay-cash`).value)||0,n=parseFloat(document.getElementById(`pay-card`).value)||0,r=parseFloat(document.getElementById(`pay-click`).value)||0,i=e-(t+n+r),a=document.getElementById(`pay-error`),s=document.getElementById(`remaining-debt-label`);i<0?(a.style.display=`block`,s.style.color=`var(--danger)`,s.textContent=c(0)+` `+o(`so'm`)):(a.style.display=`none`,s.style.color=`var(--warning)`,s.textContent=c(i)+` `+o(`so'm`))},window.payDebt=async function(e,t,n,r,i,c,l,u){e.preventDefault();let d=parseFloat(document.getElementById(`pay-cash`).value)||0,f=parseFloat(document.getElementById(`pay-card`).value)||0,p=parseFloat(document.getElementById(`pay-click`).value)||0,m=d+f+p;if(m>l){a(o(`To'lov summasi qarzdan ko'p bo'lishi mumkin emas!`),`error`);return}if(m<=0){a(o(`To'lov summasini kiriting`),`warning`);return}let h=r+d,g=i+f,_=c+p,v=l-m;try{a(o(`Saqlanmoqda...`),`info`),await s.put(`/transactions/${t}`,{total:n,cash:h,card:g,click:_,debt:v,clientId:u}),a(o(`Qarz muvaffaqiyatli to'landi!`),`success`),closeModal(),Ot()}catch(e){a(e.message,`error`)}},window.renderDebts=Ot,window.renderDebtsTabs=kt,window.renderDebtsTable=At,window.expensePage=1,window.expensePeriod=`daily`;var V=[],H=[];window.fixedPage=1;var jt=[],Mt=[];async function U(){window.expensePage=1;let e=document.getElementById(`page-content`),t=d();if(!t){e.innerHTML=`<div class="empty-state"><div class="icon">💸</div><h4>${o(`Avval biznes tanlang`)}</h4></div>`;return}try{let[n,r]=await Promise.all([s.get(`/expenses?businessId=${t}${getDateQuery()}`),s.get(`/fixed-costs?businessId=${t}`)]);H=n||[],Mt=(r||[]).filter(e=>!e.isDeleted);let i=Pt(H,window.expensePeriod).reduce((e,t)=>e+(t.total||0),0),a=window.expensePeriod===`daily`?o(`Jami xarajatlar`):window.expensePeriod===`monthly`?o(`Shu oydagi xarajatlar`):o(`Shu yildagi xarajatlar`);e.innerHTML=`
      <div class="stats-grid">
        ...
        <div class="stat-card" style="background: linear-gradient(135deg, var(--accent)1a 0%, var(--accent)05 100%); border-left: 4px solid var(--accent);">
          ...
          <div class="stat-value" style="color:var(--accent);">${Mt.length}</div>
      ...
      <div id="fixed-section"></div>
        `,Ft(),It(Mt)}catch(t){e.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(t.message)}</p></div>`}}function Nt(e){window.expensePage=1,window.expensePeriod=e,U()}function Pt(e,t){if(!e||!Array.isArray(e))return[];if(getDateQuery())return e;let n=new Date,r=n.getFullYear(),i=n.getMonth(),a=n.getDate();return e.filter(e=>{if(!e.createdAt)return!1;let n=new Date(e.createdAt);return isNaN(n.getTime())?!1:t===`daily`?n.getFullYear()===r&&n.getMonth()===i&&n.getDate()===a:t===`monthly`?n.getFullYear()===r&&n.getMonth()===i:t===`yearly`?n.getFullYear()===r:!0})}function Ft(t,n=!1){typeof t==`boolean`&&(n=t,t=null),n||(window.expensePage=1),t&&(H=t);let r=(document.getElementById(`expense-search`)?.value||``).toLowerCase().trim(),i=Pt(H,window.expensePeriod).filter(t=>{if(!r)return!0;let n=(t.description||``).toLowerCase(),i=(t.createdByName||``).toLowerCase(),a=e(t.createdAt).toLowerCase(),o=(t.createdAt||``).toLowerCase(),s=String(t.total||``),c=String(t.cash||``),l=String(t.card||``);return n.includes(r)||i.includes(r)||a.includes(r)||o.includes(r)||s.includes(r)||c.includes(r)||l.includes(r)});if(window.expensePeriod===`monthly`){let e={};i.forEach(t=>{let n=new Date(t.createdAt);if(isNaN(n.getTime()))return;let r=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}-${String(n.getDate()).padStart(2,`0`)}`;e[r]||(e[r]={total:0,cash:0,card:0,date:r,isGroup:!0}),e[r].total+=t.total||0,e[r].cash+=t.cash||0,e[r].card+=t.card||0}),V=Object.values(e).sort((e,t)=>t.date.localeCompare(e.date))}else if(window.expensePeriod===`yearly`){let e={};i.forEach(t=>{let n=new Date(t.createdAt);if(isNaN(n.getTime()))return;let r=`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}`;e[r]||(e[r]={total:0,cash:0,card:0,date:r,isGroup:!0}),e[r].total+=t.total||0,e[r].cash+=t.cash||0,e[r].card+=t.card||0}),V=Object.values(e).sort((e,t)=>t.date.localeCompare(e.date))}else V=i;let a=Math.ceil(V.length/15)||1;window.expensePage>a&&(window.expensePage=a),window.expensePage<1&&(window.expensePage=1);let s=window.expensePage*15,l=V.slice(s-15,s),d=document.getElementById(`expense-section`);if(!d)return;let f=window.expensePeriod===`daily`?o(`Kundalik xarajatlar`):window.expensePeriod===`monthly`?o(`Oylik xarajatlar`):o(`Yillik xarajatlar`),p=window.expensePeriod!==`daily`,m=l.map((t,n)=>`
      <tr>
    ...
    <tr>
      ...
      <td class="actions" style="justify-content:center">
        ...
        ${window.hasPermission(`delete`)?`<button class="btn-icon" onclick="deleteFixedCost(${t.id})" style="color:var(--danger)" title="${o(`O'chirish`)}">🗑️</button>`:``}
      </td>
    ...
    `,attachInfiniteScroll(`fixedPage`,r,`renderFixedTable`);else{let e=document.getElementById(`fixed-tbody`);e&&e.insertAdjacentHTML(`beforeend`,l);let t=document.getElementById(`fixed-pagination-area`);t&&(t.innerHTML=renderPageControls(`fixedPage`,r,`renderFixedTable`)),attachInfiniteScroll(`fixedPage`,r,`renderFixedTable`)}}function Lt(e){let t=(e||``).toLowerCase(),n=Mt.filter(e=>e.name&&String(e.name).toLowerCase().includes(t)||e.description&&String(e.description).toLowerCase().includes(t)),r=document.getElementById(`fixed-search`),i=r?r.selectionStart:0;It(n),setTimeout(()=>{let e=document.getElementById(`fixed-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}function Rt(e){let t=H.find(t=>t.id===e);t&&Ht(t)}async function zt(e){if(confirm(o(`Haqiqatan ham bu xarajatni o'chirmoqchimisiz?`)))try{await s.delete(`/expenses/`+e),a(o(`O'chirildi`)),U()}catch(e){a(e.message,`error`)}}async function Bt(e){if(confirm(o(`Haqiqatan ham bu doimiy xarajatni o'chirmoqchimisiz?`)))try{await s.delete(`/fixed-costs/`+e),a(o(`O'chirildi`)),U()}catch(e){a(e.message,`error`)}}function Vt(e){let t=document.getElementById(`exp-total`),n=document.getElementById(`exp-cash`),r=document.getElementById(`exp-card`);if(!(!t||!n||!r)){if(e===`pay`){let e=parseFloat(n.value)||0,i=parseFloat(r.value)||0;t.value=e+i>0?e+i:``}else if(e===`total`){let e=parseFloat(t.value)||0,i=parseFloat(r.value)||0;i<=0||i>e?(n.value=e>0?e:0,r.value=0):n.value=e-i}}}function Ht(e=null){let t=!!e;openModal(`
    <div class="modal-header">
    ...
    <form onsubmit="saveExpense(event, ${t?e.id:`null`})" style="width:100%">
      <div class="form-group">
        ...
        <div style="position:relative">
          <input type="number" step="0.01" class="form-control" id="exp-total" value="${t?e.total:``}" placeholder="0.00" required oninput="syncExpenseTotal('total')" style="padding-right:45px; font-weight:700; font-size:18px;">
          <span style="position:absolute; right:12px; top:50%; transform:translateY(-50%); opacity:0.5; font-size:12px;">UZS</span>
        </div>
      </div>
      ...
      <div style="background:var(--bg-input); padding:15px; border-radius:12px; margin-bottom:20px; border:1px solid var(--border);">
        ...
        <div class="form-row" style="margin-bottom:0">
          <div class="form-group" style="margin-bottom:0">
            ...
            <input type="number" step="0.01" class="form-control" id="exp-cash" value="${t?e.cash:`0`}" oninput="syncExpenseTotal('pay')">
          </div>
          <div class="form-group" style="margin-bottom:0">
            <label style="font-size:11px">${o(`Karta`)}</label>
            <input type="number" step="0.01" class="form-control" id="exp-card" value="${t?e.card:`0`}" oninput="syncExpenseTotal('pay')">
          </div>
        </div>
      </div>
  ...
  `)}async function Ut(e,t){e.preventDefault();let n=d();try{let e=parseFloat(document.getElementById(`exp-total`).value)||0,r=parseFloat(document.getElementById(`exp-cash`).value)||0,i=parseFloat(document.getElementById(`exp-card`).value)||0;r===0&&i===0&&e>0&&(r=e),r+i!==e&&(e=r+i);let c={businessId:n,total:e,cash:r,card:i,description:document.getElementById(`exp-desc`).value.trim()};t?(await s.put(`/expenses/`+t,c),a(o(`O'zgarishlar saqlandi`)),closeModal()):(await s.post(`/expenses`,c),a(o(`Xarajat qo'shildi`)),document.getElementById(`exp-total`).value=``,document.getElementById(`exp-cash`).value=`0`,document.getElementById(`exp-card`).value=`0`,document.getElementById(`exp-desc`).value=``,document.getElementById(`exp-total`).focus()),U()}catch(e){a(e.message,`error`)}}function Wt(e=null){let t=!!e;openModal(`
    <div class="modal-header">
  ...
  `)}async function Gt(e,t){e.preventDefault();let n=d();try{t?(await s.put(`/fixed-costs/${t}`,{name:document.getElementById(`fc-name`).value.trim(),description:document.getElementById(`fc-desc`).value.trim()||null,amount:parseFloat(document.getElementById(`fc-amount`).value),type:parseInt(document.getElementById(`fc-type`).value)}),a(o(`Doimiy xarajat yangilandi`)),closeModal()):(await s.post(`/fixed-costs`,{businessId:n,name:document.getElementById(`fc-name`).value.trim(),description:document.getElementById(`fc-desc`).value.trim(),amount:parseFloat(document.getElementById(`fc-amount`).value),type:parseInt(document.getElementById(`fc-type`).value)}),a(o(`Doimiy xarajat qo'shildi`)),document.getElementById(`fc-name`).value=``,document.getElementById(`fc-amount`).value=``,document.getElementById(`fc-desc`).value=``,document.getElementById(`fc-name`).focus()),U()}catch(e){a(e.message,`error`)}}window.renderExpenses=U,window.renderExpenseTable=Ft,window.filterExpensesByPeriod=Pt,window.setExpensePeriod=Nt,window.openExpenseModal=Ht,window.saveExpense=Ut,window.editExpense=Rt,window.deleteExpense=zt,window.deleteFixedCost=Bt,window.syncExpenseTotal=Vt,window.renderFixedTable=It,window.filterFixed=Lt,window.openFixedCostModal=Wt,window.saveFixedCost=Gt,window.expensePage=expensePage,window.expensePeriod=expensePeriod,window.fixedPage=fixedPage,window.allExpensesList=H,window.allFixedList=Mt,window.currentExpenses=V,window.currentFixed=jt;var Kt=1,qt=[],Jt=[];async function Yt(){let e=document.getElementById(`page-content`),t=d();try{let e=[];if(t)e=await s.get(`/calculations?businessId=${t}`);else{let t=await s.get(`/businesses/my`).catch(()=>[]);t&&t.length>0&&(e=(await Promise.all(t.map(e=>s.get(`/calculations?businessId=${e.id}`).catch(()=>[])))).flat())}Jt=(e||[]).filter(e=>e&&typeof e==`object`),Jt.sort((e,t)=>e.year===t.year?t.month-e.month:t.year-e.year),Xt(Jt)}catch(t){e.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(t.message)}</p></div>`}}function Xt(e,t=!1){typeof e==`boolean`&&(t=e,e=null),e&&(t||(window.calculationPage=1),qt=e);let n=Math.ceil(qt.length/15),r=window.calculationPage*15,i=qt.slice(r-15,r),a=[``,`Yanvar`,`Fevral`,`Mart`,`Aprel`,`May`,`Iyun`,`Iyul`,`Avgust`,`Sentabr`,`Oktabr`,`Noyabr`,`Dekabr`],s=document.getElementById(`page-content`),l=i.map(e=>{let t=o(a[e.month]||e.month),n=e.profit>=0;return`
    ...
    `,attachInfiniteScroll(`calculationPage`,n,`renderCalculationsTable`);else{let e=document.getElementById(`calculations-grid`);e&&e.insertAdjacentHTML(`beforeend`,l);let t=document.getElementById(`calculations-pagination-area`);t&&(t.innerHTML=renderPageControls(`calculationPage`,n,`renderCalculationsTable`)),attachInfiniteScroll(`calculationPage`,n,`renderCalculationsTable`)}}function Zt(e){let t=(e||``).toLowerCase(),n=[``,`yanvar`,`fevral`,`mart`,`aprel`,`may`,`iyun`,`iyul`,`avgust`,`sentabr`,`oktabr`,`noyabr`,`dekabr`],r=Jt.filter(e=>{let r=o(n[e.month]||``).toLowerCase();return String(e.year).includes(t)||r.includes(t)}),i=document.getElementById(`calculation-search`),a=i?i.selectionStart:0;Xt(r),setTimeout(()=>{let e=document.getElementById(`calculation-search`);if(e){e.focus();try{e.setSelectionRange(a,a)}catch{}}},0)}function Qt(e){let t=o([``,`Yanvar`,`Fevral`,`Mart`,`Aprel`,`May`,`Iyun`,`Iyul`,`Avgust`,`Sentabr`,`Oktabr`,`Noyabr`,`Dekabr`][e.month]||e.month);openModal(`
    <div class="modal-header">
  ...
  `)}function $t(){let e=new Date;openModal(`
  ...
  `),document.getElementById(`calc-month`).value=e.getMonth()+1}async function en(e){e.preventDefault();let t=d();try{await s.post(`/calculations`,{businessId:t,month:parseInt(document.getElementById(`calc-month`).value),year:parseInt(document.getElementById(`calc-year`).value),totalSale:parseFloat(document.getElementById(`calc-sale`).value)||0,totalIncome:parseFloat(document.getElementById(`calc-income`).value)||0,incomeTax:parseFloat(document.getElementById(`calc-income-tax`).value)||0,totalExpense:parseFloat(document.getElementById(`calc-expense`).value)||0,totalFixedCosts:parseFloat(document.getElementById(`calc-fixed`).value)||0,salary:parseFloat(document.getElementById(`calc-salary-total`).value)||0,salaryTax:0,profit:parseFloat(document.getElementById(`calc-profit`).value)||0,addedMoney:parseFloat(document.getElementById(`calc-added`).value)||0}),a(o(`Hisob-kitob yaratildi`)),closeModal(),Yt()}catch(e){a(e.message,`error`)}}async function tn(){let e=d(),t=document.getElementById(`calc-month`).value,n=document.getElementById(`calc-year`).value;if(!e){a(o(`Iltimos, avval do'konni tanlang`),`warning`);return}if(!(!t||!n))try{let r=await s.get(`/calculations/stats?businessId=${e}&month=${t}&year=${n}`);document.getElementById(`calc-sale`).value=r.totalSale||0,document.getElementById(`calc-income`).value=r.totalIncome||0,document.getElementById(`calc-expense`).value=r.totalExpense||0,document.getElementById(`calc-fixed`).value=r.totalFixedCosts||0,document.getElementById(`calc-salary-total`).value=r.totalSalary||0,nn()}catch(e){a(e.message,`error`)}}function nn(){let e=parseFloat(document.getElementById(`calc-income`).value)||0,t=parseFloat(document.getElementById(`calc-expense`).value)||0,n=parseFloat(document.getElementById(`calc-fixed`).value)||0,r=parseFloat(document.getElementById(`calc-salary-total`).value)||0,i=parseFloat(document.getElementById(`calc-added`).value)||0,a=parseFloat(document.getElementById(`calc-income-tax`).value)||0,o=e-t-n-r+i-a;document.getElementById(`calc-profit`).value=o.toFixed(2)}window.showIncomeBreakdown=async function(e,t,n){try{let r=await s.get(`/calculations/income-breakdown?businessId=${e}&month=${t}&year=${n}`);if(!r||r.length===0){a(o(`Ma'lumot topilmadi`),`info`);return}let i=``;(r||[]).forEach(e=>{i+=`
    ...
    `,i=document.createElement(`div`);i.className=`modal-overlay active`,i.style.zIndex=`2000`;let l=document.createElement(`div`);l.className=`modal`,l.style.width=`600px`,l.innerHTML=r,i.appendChild(l),document.body.appendChild(i)}catch(e){a(e.message,`error`)}},window.renderCalculations=Yt,window.renderCalculationsTable=Xt,window.filterCalculations=Zt,window.openCalculationModal=$t,window.createCalculation=en,window.viewCalculationDetail=Qt,window.syncCalculationStats=tn,window.calculateNetProfit=nn,window.calculationPage=Kt,window.allCalculationsList=Jt,window.currentCalculations=qt;var rn=`users`;async function an(){let e=document.getElementById(`page-content`),t=(s.getUser()||{}).role===2;e.innerHTML=`
    ...
    `,on(rn)}function on(e){(s.getUser()||{}).role!==2&&[`regions`,`districts`,`markets`,`referrals`].includes(e)&&(e=`users`),rn=e,document.querySelectorAll(`.admin-tabs .btn`).forEach(e=>{e.classList.remove(`active`),e.classList.replace(`btn-primary`,`btn-secondary`)});let t=document.getElementById(`tab-`+e);switch(t&&(t.classList.add(`active`),t.classList.replace(`btn-secondary`,`btn-primary`)),e){case`users`:ln();break;case`regions`:An();break;case`districts`:Bn();break;case`markets`:X();break;case`referrals`:qn();break}}var sn=1,cn=[];async function ln(){let e=document.getElementById(`admin-content`);e.innerHTML=`<div class="loader"></div>`;try{let e=s.getUser()||{},t;t=e.role===2?await s.get(`/admin/users`):await s.get(`/users/my-employees`),cn=t||[],gn(cn)}catch(t){e.innerHTML=`<p class="error">${o(`Xatolik`)}: `+t.message+`</p>`}}var W=1,un=[],dn=[],G=1,fn=[],pn=[],K=1,mn=[],hn=[];function gn(e,t=!1){e===!0&&(t=!0,e=null),Array.isArray(e)&&(cn=e);let n=(document.getElementById(`admin-user-search`)?.value||``).toLowerCase(),r=cn.filter(e=>{let t=e.role===2?`super admin`:e.role===1?`admin`:e.role===3?`client`:`employee`;return e.firstName&&String(e.firstName).toLowerCase().includes(n)||e.lastName&&String(e.lastName).toLowerCase().includes(n)||e.userName&&String(e.userName).toLowerCase().includes(n)||e.phoneNumber&&String(e.phoneNumber).toLowerCase().includes(n)||t.includes(n)}),i=r.filter(e=>e.role===2),a=r.filter(e=>e.role===1),s=r.filter(e=>e.role===0),c=r.filter(e=>e.role===3),l=document.getElementById(`admin-content`),d=`
    ...
    `;i.length>0&&(d+=`<h4 style="margin-bottom:15px; color:var(--primary); display:flex; align-items:center; gap:10px;">🌟 Super Admins <span class="badge badge-success">${i.length}</span></h4>`,i.forEach(e=>{d+=_n(e)})),a.length>0&&(d+=`<h4 style="margin:25px 0 15px; color:var(--warning); display:flex; align-items:center; gap:10px;">🏢 Admins & Teams <span class="badge badge-warning">${a.length}</span></h4>`,a.forEach(e=>{let t=s.filter(t=>t.createdBy===e.id);d+=vn(e,t)}));let f=s.filter(e=>!a.find(t=>t.id===e.createdBy));(f.length>0||c.length>0)&&(d+=`<h4 style="margin:25px 0 15px; color:var(--text-muted);">${o(`Boshqa foydalanuvchilar`)}</h4>`,[...f,...c].forEach(e=>{d+=_n(e)})),r.length===0&&(d+=`<div class="empty-state">${o(`Ma'lumot yo'q`)}</div>`),d+=`</div></div>`,l.innerHTML=d}function _n(e){let t=(e.isExpired||e.expirationDate&&new Date(e.expirationDate)<new Date)&&e.role!==2,n=e.role===2?`Super Admin`:e.role===1?`Admin`:e.role===3?`Client`:`Employee`,r=e.role===2?`badge-success`:e.role===1?`badge-warning`:e.role===3?`badge-info`:``;return`
    ...
    `}function vn(e,t){let n=(e.isExpired||e.expirationDate&&new Date(e.expirationDate)<new Date)&&e.role!==2,r=`user-acc-${e.id}`;return`
    ...
    `}function yn(e){let t=(e||``).toLowerCase(),n=cn.filter(e=>{let n=e.role===2?`super admin`:e.role===1?`admin`:e.role===3?`client`:`employee`;return e.firstName&&String(e.firstName).toLowerCase().includes(t)||e.lastName&&String(e.lastName).toLowerCase().includes(t)||e.userName&&String(e.userName).toLowerCase().includes(t)||e.phoneNumber&&String(e.phoneNumber).toLowerCase().includes(t)||n.includes(t)}),r=document.getElementById(`admin-user-search`),i=r?r.selectionStart:0;gn(n),setTimeout(()=>{let e=document.getElementById(`admin-user-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}function bn(){openModal(o(`Yangi foydalanuvchi`),`
    ...
    `)}async function Cn(e,t){e.preventDefault();let n={firstName:document.getElementById(`edit-firstName`).value,lastName:document.getElementById(`edit-lastName`).value,phoneNumber:document.getElementById(`edit-phone`).value,role:parseInt(document.getElementById(`edit-role`).value),isExpired:document.getElementById(`edit-expired`).value===`true`,isMarketplaceEnabled:document.getElementById(`edit-mp-enabled`).checked},r=document.getElementById(`edit-expiration`).value;r&&(n.expirationDate=new Date(r).toISOString()),n.brandName=document.getElementById(`edit-brandName`).value,n.brandImage=document.getElementById(`edit-brandImage`).value,n.image=document.getElementById(`edit-image`).value;let i=document.getElementById(`edit-password`).value;i&&(n.password=i);try{await s.put(`/admin/users/`+t,n),a(o(`Foydalanuvchi yangilandi`),`success`),closeModal(),ln()}catch(e){a(o(e.message),`error`)}}async function wn(e,t,n){if(e.files&&e.files[0]){let r=new FormData;r.append(`file`,e.files[0]);try{let e=await s.post(`/upload`,r);e.url&&(document.getElementById(t).value=e.url,document.getElementById(n).innerHTML=`<img src="${e.url}" style="width:100%; height:100%; object-fit:cover;">`)}catch(e){a(e.message,`error`)}}}async function Tn(e){wn(e,`edit-brandImage`,`admin-brand-preview`)}async function En(e,t){try{await s.put(`/admin/users/`+e,{isMarketplaceEnabled:!t}),a(o(`Marketplace ruxsati o'zgartirildi`),`success`),ln()}catch(e){a(o(e.message),`error`)}}async function Dn(e){if(confirm(o(`Foydalanuvchini o'chirishni xohlaysizmi?`)))try{await s.delete(`/admin/users/`+e),a(o(`Foydalanuvchi o'chirildi`),`success`),ln()}catch(e){a(o(e.message),`error`)}}var q=1,On=[],kn=[];async function An(){let e=document.getElementById(`admin-content`);e.innerHTML=`<div class="loader"></div>`;try{kn=await s.get(`/admin/regions`)||[],jn(kn)}catch(t){e.innerHTML=`<p class="error">${o(`Xatolik`)}: `+t.message+`</p>`}}function jn(e,t=!1){e===!0&&(t=!0,e=null),Array.isArray(e)&&(On=e,q=1);let n=Math.ceil(On.length/10);q>n&&(q=n||1);let r=(q-1)*10,i=On.slice(r,r+10),a=i.length===0&&!t?`<tr><td colspan="4" style="text-align:center;color:var(--text-muted);">${o(`Ma'lumot yo'q`)}</td></tr>`:i.map((e,t)=>`
            <tr>
    ...
    `,setTimeout(()=>{attachInfiniteScroll(`adminRegionPage`,n,`renderAdminRegionsTable`)},100)}function Mn(e){let t=(e||``).toLowerCase(),n=kn.filter(e=>e.name&&String(e.name).toLowerCase().includes(t)),r=document.getElementById(`admin-region-search`),i=r?r.selectionStart:0;jn(n),setTimeout(()=>{let e=document.getElementById(`admin-region-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}function Nn(e,t){let n=!!e;openModal(o(n?`Viloyatni tahrirlash`:`Yangi viloyat`),`
    ...
    `)}async function Pn(e){e.preventDefault();try{await s.post(`/admin/regions`,{name:document.getElementById(`region-name`).value}),a(o(`Viloyat yaratildi`),`success`),closeModal(),An()}catch(e){a(e.message,`error`)}}async function Fn(e,t){e.preventDefault();try{await s.put(`/admin/regions/`+t,{name:document.getElementById(`region-name`).value}),a(o(`Viloyat yangilandi`),`success`),closeModal(),An()}catch(e){a(e.message,`error`)}}async function In(e){if(confirm(o(`Viloyatni o'chirishni xohlaysizmi?`)))try{await s.delete(`/admin/regions/`+e),a(o(`Viloyat o'chirildi`),`success`),An()}catch(e){a(e.message,`error`)}}var J=1,Ln=[],Rn=[],zn=[];async function Bn(){let e=document.getElementById(`admin-content`);e.innerHTML=`<div class="loader"></div>`;try{let[e,t]=await Promise.all([s.get(`/admin/districts`),s.get(`/admin/regions`)]);zn=t||[],Rn=e||[],Vn(Rn)}catch(t){e.innerHTML=`<p class="error">${o(`Xatolik`)}: `+t.message+`</p>`}}function Vn(e,t=!1){e===!0&&(t=!0,e=null),Array.isArray(e)&&(Ln=e,J=1);let n=Math.ceil(Ln.length/10);J>n&&(J=n||1);let r=(J-1)*10,i=Ln.slice(r,r+10),a=i.length===0&&!t?`<tr><td colspan="5" style="text-align:center;color:var(--text-muted);">${o(`Ma'lumot yo'q`)}</td></tr>`:i.map((e,t)=>`
            <tr>
                <td style="text-align:center">${r+t+1}</td>
                <td style="text-align:center">${u(e.name)}</td>
                <td style="text-align:center">${u(e.regionName||``)}</td>
                <td class="actions" style="justify-content:center">
                    <button class="btn-icon" onclick='openDistrictModal(${e.id}, "${u(e.name)}", ${e.regionId}, ${JSON.stringify(JSON.stringify(zn)).replace(/'/g,`&#39;`)})' title="${o(`Tahrirlash`)}">✏️</button>
        ...
        <div class="card" style="margin-top:20px">
            <div class="card-header">
              <div class="toolbar" style="width:100%">
                ...
                <button class="btn btn-primary btn-sm" onclick='openDistrictModal(null, null, null, ${JSON.stringify(JSON.stringify(zn)).replace(/'/g,`&#39;`)})'>${o(`Qo'shish`)}</button>
              </div>
            </div>
            <div class="table-container" style="overflow-x: auto; overflow-y: auto; max-height: calc(100vh - 250px);">
    ...
    `,setTimeout(()=>{attachInfiniteScroll(`adminDistrictPage`,n,`renderAdminDistrictsTable`)},100)}function Hn(e){let t=(e||``).toLowerCase(),n=Rn.filter(e=>e.name&&String(e.name).toLowerCase().includes(t)||e.regionName&&String(e.regionName).toLowerCase().includes(t)),r=document.getElementById(`admin-district-search`),i=r?r.selectionStart:0;Vn(n),setTimeout(()=>{let e=document.getElementById(`admin-district-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}function Un(e,t,n,r){let i=!!e,a=JSON.parse(r);openModal(o(i?`Tumanni tahrirlash`:`Yangi tuman`),`
    ...
    `)}async function Wn(e){e.preventDefault();try{await s.post(`/admin/districts`,{name:document.getElementById(`district-name`).value,regionId:parseInt(document.getElementById(`district-regionId`).value)}),a(o(`Tuman yaratildi`),`success`),closeModal(),Bn()}catch(e){a(e.message,`error`)}}async function Gn(e,t){e.preventDefault();try{await s.put(`/admin/districts/`+t,{name:document.getElementById(`district-name`).value,regionId:parseInt(document.getElementById(`district-regionId`).value)}),a(o(`Tuman yangilandi`),`success`),closeModal(),Bn()}catch(e){a(e.message,`error`)}}async function Kn(e){if(confirm(o(`Tumanni o'chirishni xohlaysizmi?`)))try{await s.delete(`/admin/districts/`+e),a(o(`Tuman o'chirildi`),`success`),Bn()}catch(e){a(e.message,`error`)}}async function qn(){let e=document.getElementById(`admin-content`);e.innerHTML=`<div class="loader"></div>`;try{Jn(await s.get(`/users/referred`)||[])}catch(t){e.innerHTML=`<p class="error">${o(`Xatolik`)}: `+t.message+`</p>`}}function Jn(e){let t=document.getElementById(`admin-content`),n=s.getUser()||{},r=n.userName?n.userName.toUpperCase():`ADMIN`,a=e.length===0?`<tr><td colspan="5" style="text-align:center;color:var(--text-muted);">${o(`Hali hech kim taklif qilinmagan`)}</td></tr>`:e.map((e,t)=>{let n=e.role===2?`Super Admin`:e.role===1?`Admin`:e.role===3?`Client`:`Employee`;return`
                <tr>
    ...
    `}var Y=1,Yn=[],Xn=[],Zn=[];async function X(){let e=document.getElementById(`admin-content`);e.innerHTML=`<div class="loader"></div>`;try{let[e,t]=await Promise.all([s.get(`/admin/markets`),s.get(`/admin/districts`)]);Zn=t||[],Xn=e||[],Qn(Xn)}catch(t){e.innerHTML=`<p class="error">${o(`Xatolik`)}: `+t.message+`</p>`}}function Qn(e,t=!1){e===!0&&(t=!0,e=null),Array.isArray(e)&&(Yn=e,Y=1);let n=Math.ceil(Yn.length/10);Y>n&&(Y=n||1);let r=(Y-1)*10,i=Yn.slice(r,r+10),a=i.length===0&&!t?`<tr><td colspan="6" style="text-align:center;color:var(--text-muted);">${o(`Ma'lumot yo'q`)}</td></tr>`:i.map((e,t)=>`
            <tr>
                <td style="text-align:center">${r+t+1}</td>
                <td style="text-align:center">${u(e.name)}</td>
                ...
                <td class="actions" style="justify-content:center">
                    <button class="btn-icon" onclick='openMarketModal(${e.id}, "${u(e.name)}", "${u(e.address||``)}", ${e.districtId}, ${JSON.stringify(JSON.stringify(Zn)).replace(/'/g,`&#39;`)})' title="${o(`Tahrirlash`)}">✏️</button>
        ...
        <div class="card" style="margin-top:20px">
            <div class="card-header">
              <div class="toolbar" style="width:100%">
                ...
                <button class="btn btn-primary btn-sm" onclick='openMarketModal(null, null, null, null, ${JSON.stringify(JSON.stringify(Zn)).replace(/'/g,`&#39;`)})'>${o(`Qo'shish`)}</button>
              </div>
            </div>
            <div class="table-container" style="overflow-x: auto; overflow-y: auto; max-height: calc(100vh - 250px);">
    ...
    `,setTimeout(()=>{attachInfiniteScroll(`adminMarketPage`,n,`renderAdminMarketsTable`)},100)}function $n(e){let t=(e||``).toLowerCase(),n=Xn.filter(e=>e.name&&String(e.name).toLowerCase().includes(t)||e.address&&String(e.address).toLowerCase().includes(t)||e.districtName&&String(e.districtName).toLowerCase().includes(t)),r=document.getElementById(`admin-market-search`),i=r?r.selectionStart:0;Qn(n),setTimeout(()=>{let e=document.getElementById(`admin-market-search`);if(e){e.focus();try{e.setSelectionRange(i,i)}catch{}}},0)}function er(e,t,n,r,i){let a=!!e,s=JSON.parse(i);openModal(o(a?`Bozorni tahrirlash`:`Yangi bozor`),`
    ...
    `)}async function tr(e){e.preventDefault();try{await s.post(`/admin/markets`,{name:document.getElementById(`market-name`).value,address:document.getElementById(`market-address`).value,districtId:parseInt(document.getElementById(`market-districtId`).value)}),a(o(`Bozor yaratildi`),`success`),closeModal(),X()}catch(e){a(e.message,`error`)}}async function nr(e,t){e.preventDefault();try{await s.put(`/admin/markets/`+t,{name:document.getElementById(`market-name`).value,address:document.getElementById(`market-address`).value,districtId:parseInt(document.getElementById(`market-districtId`).value)}),a(o(`Bozor yangilandi`),`success`),closeModal(),X()}catch(e){a(e.message,`error`)}}async function rr(e){if(confirm(o(`Bozorni o'chirishni xohlaysizmi?`)))try{await s.delete(`/admin/markets/`+e),a(o(`Bozor o'chirildi`),`success`),X()}catch(e){a(e.message,`error`)}}async function ir(){let e=document.getElementById(`admin-content`);e.innerHTML=`<div class="loader"></div>`;try{let[t,n]=await Promise.all([s.get(`/admin/marketplace/products`),s.get(`/admin/marketplace/categories`)]);e.innerHTML=`
            <!-- Categories Card -->
            <div class="card" style="margin-top:20px">
                <div class="card-header">
        ...
        `}catch(t){e.innerHTML=`<p class="error">${o(`Xatolik`)}: ${o(t.message)}</p>`}}function ar(e,t){let n=!!e;openModal(o(n?`Kategoriyani tahrirlash`:`Yangi kategoriya`),`
    ...
    `)}async function or(e,t){e.preventDefault();let n=document.getElementById(`mp-cat-name`).value,r=document.getElementById(`mp-cat-image`).files[0];try{let e=``;if(r){let t=new FormData;t.append(`file`,r),e=(await s.post(`/upload`,t)).url}let i={name:n};e&&(i.image=e),t?(await s.put(`/admin/marketplace/categories/${t}`,i),a(o(`Yangilandi`),`success`)):(await s.post(`/admin/marketplace/categories`,i),a(o(`Yaratildi`),`success`)),closeModal(),window.currentPage===`mp-categories`?hr():window.currentPage===`mp-products`?vr():an()}catch(e){a(e.message,`error`)}}async function sr(e){if(confirm(o(`O'chirishni xohlaysizmi?`)))try{await s.delete(`/admin/marketplace/categories/${e}`),a(o(`O'chirildi`),`success`),hr()}catch(e){a(e.message,`error`)}}async function cr(e,t){try{await s.put(`/admin/marketplace/products/${e}`,{isVisible:!t}),a(o(`Muvaffaqiyatli`),`success`),vr()}catch(e){a(e.message,`error`)}}async function lr(e){if(confirm(o(`O'chirishni xohlaysizmi?`)))try{await s.delete(`/admin/marketplace/products/${e}`),a(o(`O'chirildi`),`success`),vr()}catch(e){a(e.message,`error`)}}async function ur(){openModal(o(`Marketplace'ga mahsulot qo'shish`),`
    ...
    `);try{let e=s.getUser(),t=e&&e.role===2?`/businesses`:`/businesses/my`,n=await s.get(t),r=document.getElementById(`mp-biz-id`);(n||[]).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name,r.appendChild(t)})}catch(e){a(o(e.message),`error`)}}async function dr(e){if(e)try{let e=await s.get(`/marketplace/categories`),t=document.getElementById(`mp-category-id`);t.innerHTML=`<option value="">${o(`Tanlang...`)}</option>`,(e||[]).forEach(e=>{let n=document.createElement(`option`);n.value=e.id,n.textContent=e.name,t.appendChild(n)}),document.getElementById(`mp-cat-container`).style.display=`block`,document.getElementById(`mp-prod-form`).style.display=`none`}catch(e){a(o(e.message),`error`)}}function fr(){document.getElementById(`mp-category-id`).value&&(document.getElementById(`mp-prod-form`).style.display=`block`,document.getElementById(`mp-initial-footer`).style.display=`none`)}async function pr(e){e.preventDefault();let t=document.getElementById(`mp-image`).files[0];try{let e=``;if(t){let n=new FormData;n.append(`file`,t),e=(await s.post(`/upload`,n)).url}let n={businessId:document.getElementById(`mp-biz-id`).value?parseInt(document.getElementById(`mp-biz-id`).value):null,marketplaceCategoryId:document.getElementById(`mp-category-id`).value?parseInt(document.getElementById(`mp-category-id`).value):null,name:document.getElementById(`mp-name`).value,price:parseFloat(document.getElementById(`mp-price`).value),quantity:parseInt(document.getElementById(`mp-qty`).value),shortDescription:document.getElementById(`mp-short-desc`).value,images:e};await s.post(`/admin/marketplace/products`,n),a(o(`Qo'shildi`),`success`),closeModal(),vr()}catch(e){a(e.message,`error`)}}async function mr(){let e=document.getElementById(`page-content`);e.innerHTML=`<div class="loader"></div>`;try{let[t,n]=await Promise.all([s.get(`/admin/marketplace/products`),s.get(`/admin/marketplace/categories`)]),r=(t||[]).length,i=(n||[]).length,a=(t||[]).filter(e=>e.isVisible).length,c=(t||[]).reduce((e,t)=>e+t.quantity,0);e.innerHTML=`
        ...
        `}catch(t){e.innerHTML=`<p class="error">${o(t.message)}</p>`}}async function hr(){let e=document.getElementById(`page-content`);e.innerHTML=`<div class="loader"></div>`;try{un=await s.get(`/admin/marketplace/categories`)||[],W=1,gr(un)}catch(t){e.innerHTML=`<p class="error">${o(t.message)}</p>`}}function gr(e,t=!1){e===!0&&(t=!0,e=null),Array.isArray(e)&&(dn=e,W=1);let n=document.getElementById(`page-content`),r=Math.ceil(dn.length/10);W>r&&(W=r||1);let i=(W-1)*10,a=dn.slice(i,i+10),s=a.length===0&&!t?`<tr><td colspan="3" style="text-align:center; padding:40px; color:var(--text-muted);">${o(`Ma'lumot yo'q`)}</td></tr>`:a.map((e,t)=>`
            <tr>
    ...
    `,typeof lucide<`u`&&lucide.createIcons(),setTimeout(()=>{attachInfiniteScroll(`mpCategoryPage`,r,`renderMpCategoriesTable`)},100)}function _r(e){let t=e.toLowerCase(),n=un.filter(e=>e.name.toLowerCase().includes(t));W=1,gr(n),setTimeout(()=>{let t=document.getElementById(`mp-category-search`);t&&(t.focus(),t.value=e)},0)}async function vr(){let e=document.getElementById(`page-content`);e.innerHTML=`<div class="loader"></div>`;try{let e=getSelectedBusinessId();fn=await s.get(`/admin/marketplace/products?businessId=${e}`)||[],G=1,yr(fn)}catch(t){e.innerHTML=`<p class="error">${o(t.message)}</p>`}}function yr(e,t=!1){e===!0&&(t=!0,e=null),Array.isArray(e)&&(pn=e,G=1);let n=document.getElementById(`page-content`),r=Math.ceil(pn.length/10);G>r&&(G=r||1);let i=(G-1)*10,a=pn.slice(i,i+10),s=a.length===0&&!t?`<tr><td colspan="8" style="text-align:center; padding:40px; color:var(--text-muted);">${o(`Ma'lumot yo'q`)}</td></tr>`:a.map((e,t)=>`
            <tr>
                <td style="text-align:center; font-weight:600;">${i+t+1}</td>
                <td>
    ...
    `,typeof lucide<`u`&&lucide.createIcons(),setTimeout(()=>{attachInfiniteScroll(`mpProductPage`,r,`renderMpProductsTable`)},100)}function br(e){let t=e.toLowerCase(),n=fn.filter(e=>e.name.toLowerCase().includes(t)||e.businessName&&e.businessName.toLowerCase().includes(t)||e.shortDescription&&e.shortDescription.toLowerCase().includes(t));G=1,yr(n),setTimeout(()=>{let t=document.getElementById(`mp-product-search`);t&&(t.focus(),t.value=e)},0)}async function xr(){let e=document.getElementById(`page-content`);e.innerHTML=`<div class="loader"></div>`;try{let e=getSelectedBusinessId();mn=(await s.get(`/admin/marketplace/orders?businessId=${e}&status=CONFIRMED,DELIVERED`)||[]).map(e=>({id:e.id,createdAt:e.createdAt,customerName:`${e.customer?.firstName||``} ${e.customer?.lastName||``}`,productNames:(e.items||[]).map(e=>e.product?.name).join(`, `),total:e.totalSum,status:e.status})),K=1,Sr(mn)}catch(t){e.innerHTML=`<p class="error">${o(t.message)}</p>`}}function Sr(e,t=!1){e===!0&&(t=!0,e=null),Array.isArray(e)&&(hn=e,K=1);let n=document.getElementById(`page-content`),r=Math.ceil(hn.length/10);K>r&&(K=r||1);let i=(K-1)*10,a=hn.slice(i,i+10),s=a.length===0&&!t?`
        <tr>
    ...
    `,typeof lucide<`u`&&lucide.createIcons(),setTimeout(()=>{attachInfiniteScroll(`mpSalesPage`,r,`renderMpSalesTable`)},100)}function Cr(e){let t=e.toLowerCase(),n=mn.filter(e=>e.customerName&&e.customerName.toLowerCase().includes(t)||e.productNames&&e.productNames.toLowerCase().includes(t));K=1,Sr(n),setTimeout(()=>{let t=document.getElementById(`mp-sales-search`);t&&(t.focus(),t.value=e)},0)}window.renderMpStats=mr,window.renderMpCategories=hr,window.renderMpProducts=vr,window.renderMpSales=xr,window.renderMpSalesTable=Sr,window.filterMpSales=Cr,window.renderMpCategoriesTable=gr,window.filterMpCategories=_r,window.renderMpProductsTable=yr,window.filterMpProducts=br,Object.defineProperty(window,`mpCategoryPage`,{get:()=>W,set:e=>W=e}),Object.defineProperty(window,`mpProductPage`,{get:()=>G,set:e=>G=e}),Object.defineProperty(window,`mpSalesPage`,{get:()=>K,set:e=>K=e}),window.renderAdmin=an,window.activeAdminTab=rn,window.showAdminTab=on,window.loadAdminMarketplace=ir,window.openMpCategoryModal=ar,window.submitMpCategory=or,window.deleteMpCategory=sr,window.openCreateMpProductModal=ur,window.loadMpCategories=dr,window.showMpForm=fr,window.submitMpProduct=pr,window.toggleMpProductVisibility=cr,window.deleteMpProduct=lr,window.openEditUserModal=Sn,window.saveAdminUser=Cn,window.deleteAdminUser=Dn,window.renderAdminUsersTable=gn,window.filterAdminUsers=yn,window.openCreateUserModal=bn,window.createAdminUser=xn,window.previewAdminBrandImage=Tn,window.loadAdminReferrals=qn,window.renderAdminReferrals=Jn,Object.defineProperty(window,`adminUserPage`,{get:()=>sn,set:e=>sn=e}),Object.defineProperty(window,`adminRegionPage`,{get:()=>q,set:e=>q=e}),Object.defineProperty(window,`adminDistrictPage`,{get:()=>J,set:e=>J=e}),Object.defineProperty(window,`adminMarketPage`,{get:()=>Y,set:e=>Y=e}),window.loadAdminRegions=An,window.renderAdminRegionsTable=jn,window.filterAdminRegions=Mn,window.openRegionModal=Nn,window.createRegion=Pn,window.updateRegion=Fn,window.deleteRegion=In,window.loadAdminDistricts=Bn,window.renderAdminDistrictsTable=Vn,window.filterAdminDistricts=Hn,window.openDistrictModal=Un,window.createDistrict=Wn,window.updateDistrict=Gn,window.deleteDistrict=Kn,window.loadAdminMarkets=X,window.renderAdminMarketsTable=Qn,window.filterAdminMarkets=$n,window.openMarketModal=er,window.createMarket=tr,window.updateMarket=nr,window.deleteMarket=rr;async function wr(){let e=document.getElementById(`page-content`);e.innerHTML=`<div class="loader"></div>`;try{let t=getSelectedBusinessId(),n=await s.get(`/admin/marketplace/orders?businessId=${t}`);e.innerHTML=`
            <div class="card">
                <div class="card-header">
        ...
        `}catch(t){e.innerHTML=`<div class="error-state">${o(t.message)}</div>`}}async function Tr(e,t){if(confirm(o(`Buyurtmani ${t===`CONFIRMED`?`tasdiqlashni`:`rad etishni`} xohlaysizmi?`)))try{await s.put(`/admin/marketplace/orders/${e}/status`,{status:t}),a(o(`Holat yangilandi`),`success`),wr()}catch(e){a(o(e.message),`error`)}}window.renderMpOrders=wr,window.updateMpOrderStatus=Tr,window.toggleMarketplaceAccess=En,(function(){s.getToken()||(window.location.href=`index.html`)})();var Er=`dashboard`,Dr=[],Or=[],kr=`line`;document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`lang-selector-app`);e&&(e.value=l);let t=document.getElementById(`lang-selector-sidebar`);t&&(t.value=l),Ar(),jr().then(()=>{typeof translateDOM==`function`&&translateDOM(),Z(getSelectedPage())});let n=e=>{let t=e.target;(t.tagName===`INPUT`||t.tagName===`TEXTAREA`)&&(t.closest(`#modal-overlay`)||t.closest(`.modal`))&&setTimeout(()=>{try{typeof t.select==`function`&&t.select()}catch{}},10)};document.addEventListener(`focusin`,n),document.addEventListener(`click`,e=>{(e.target.tagName===`INPUT`||e.target.tagName===`TEXTAREA`)&&n(e)}),document.addEventListener(`keydown`,e=>{let t=e.target;t.tagName===`INPUT`&&t.closest(`#modal-overlay`)&&(t.dataset.origPlaceholder||(t.dataset.origPlaceholder=t.placeholder),t.placeholder&&e.key&&e.key.length===1&&(t.placeholder=``))}),document.addEventListener(`input`,e=>{let t=e.target;t.tagName===`INPUT`&&t.closest(`#modal-overlay`)&&(t.value.length===0&&t.dataset.origPlaceholder?t.placeholder=t.dataset.origPlaceholder:t.placeholder=``)})});function Ar(){let e=s.getUser();if(e){document.getElementById(`user-name`).textContent=`${e.firstName} ${e.lastName}`;let t=document.getElementById(`user-avatar`);e.image&&e.image.trim()!==``?(t.innerHTML=`<img src="${e.image}" style="width:100%; height:100%; object-fit:cover; border-radius:50%;">`,t.style.background=`none`):t.textContent=(e.firstName||`U`)[0].toUpperCase();let n=parseInt(e.role);document.body.classList.remove(`is-employee`,`is-owner`,`is-admin`),n===0?document.body.classList.add(`is-employee`):n===1?document.body.classList.add(`is-owner`):n===2&&document.body.classList.add(`is-admin`);let r=document.querySelector(`.sidebar-logo .brand-name`);if(r&&(r.textContent=e.brandName||`SavdoSklad`),document.title=`${e.brandName||`SavdoSklad`} — Biznes Boshqaruv Tizimi`,e.brandImage){let t=document.getElementById(`sidebar-brand-icon`);t&&(t.style.width=`36px`,t.style.height=`36px`,t.style.background=`none`,t.style.boxShadow=`none`,t.innerHTML=`<img src="${e.brandImage}" style="width:100%; height:100%; object-fit:cover; border-radius:10px;">`)}document.querySelectorAll(`.owner-only`).forEach(e=>{e.style.display=n>=1?`flex`:`none`}),document.querySelectorAll(`.admin-only`).forEach(e=>{e.style.display=n===2?`flex`:`none`}),document.querySelectorAll(`.mp-only`).forEach(e=>{e.style.display=n>=1?`block`:`none`}),document.querySelectorAll(`.admin-only-mp`).forEach(e=>{e.style.display=n===2?`flex`:`none`})}}async function jr(){try{let e=await s.get(`/businesses/my`),n=document.getElementById(`business-selector`);if(!n)return;let r=[`categories`,`transactions`,`refunds`,`debts`,`expenses`,`calculations`,`mp-categories`,`mp-stats`,`mp-products`,`mp-sales`,`mp-orders`,`admin`].includes(window.currentPage||`dashboard`)?`Biznes tanlang`:`Hammasi`;if(n.innerHTML=`<option value="" data-i18n="${r}">${o(r)}</option>`,e&&e.length>0){(e||[]).forEach(e=>{let t=document.createElement(`option`);t.value=e.id,t.textContent=e.name||`Biznes #${e.id}`,n.appendChild(t)});let r=d();if(r&&e.find(e=>e.id==r))n.value=r;else if(e.length>0){let r=e[0].id;n.value=r,t(r)}else n.value=``,t(0)}else t(0);Z(Er)}catch(e){a(e.message,`error`)}}function Mr(e){t(e),Z(Er)}function Z(e){let t=s.getUser(),n=t?parseInt(t.role):0,r=[`employees`,`expenses`,`businesses`,`calculations`,`bulk-delete`,`mp-stats`,`mp-categories`,`mp-products`,`mp-sales`,`mp-orders`],i=[`admin`];if(n<1&&(r.includes(e)||i.includes(e))){console.warn(`RBAC: Access denied to`,e),Z(`dashboard`);return}if(n<2&&i.includes(e)){console.warn(`RBAC: Access denied to`,e),Z(`dashboard`);return}Er=e,window.currentPage=e,setSelectedPage(e),document.querySelectorAll(`.nav-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.page===e)});let a={dashboard:`Bosh sahifa`,businesses:`Bizneslar`,categories:`Kategoriyalar`,products:`Mahsulotlar`,transactions:`Sotuvlar`,refunds:`Qaytarishlar`,debts:`Qarzlar`,clients:`Mijozlar`,employees:`Xodimlar`,expenses:`Xarajatlar`,calculations:`Hisobotlar`,admin:`Admin panel`,profile:`Shaxsiy kabinet`,"bulk-delete":`Ommaviy o'chirish`,"mp-stats":`Marketplace: Statistika`,"mp-categories":`Marketplace: Kategoriyalar`,"mp-products":`Marketplace: Mahsulotlar`,"mp-sales":`Marketplace: Sotilgan tovarlar`,"mp-orders":`Marketplace: Buyurtmalar`};document.getElementById(`page-title`).textContent=o(a[e]||e),document.title=`SavdoSklad — ${o(a[e]||e)}`;let c=document.getElementById(`business-selector`);if(c&&c.options.length>0){let t=[`categories`,`transactions`,`refunds`,`debts`,`expenses`,`calculations`,`mp-categories`,`mp-stats`,`mp-products`,`mp-sales`,`mp-orders`,`admin`].includes(e)?`Biznes tanlang`:`Hammasi`;c.options[0].textContent=o(t),c.options[0].setAttribute(`data-i18n`,t);let n=d();c.value=Array.from(c.options).some(e=>e.value==n)&&n||``}let l=document.getElementById(`topbar-page-title-center`);l&&(l.textContent=o(a[e]||e));let u=document.getElementById(`topbar-date`);if(u){let e=new Date,t=e.getDate(),n=e.getMonth(),r=e.getFullYear(),i=e.getDay();u.textContent=`${t} ${o([`Yanvar`,`Fevral`,`Mart`,`Aprel`,`May`,`Iyun`,`Iyul`,`Avgust`,`Sentabr`,`Oktabr`,`Noyabr`,`Dekabr`][n])} ${r}, ${o([`Yakshanba`,`Dushanba`,`Seshanba`,`Chorshanba`,`Payshanba`,`Juma`,`Shanba`][i])}`}let f=document.getElementById(`page-content`);switch(f.innerHTML=`<div class="loader"><div class="spinner"></div></div>`,f.className=`content fade-in`,e){case`dashboard`:Nr();break;case`businesses`:renderBusinesses();break;case`categories`:renderCategories();break;case`products`:renderProducts();break;case`transactions`:renderTransactions();break;case`refunds`:renderRefunds();break;case`debts`:window.renderDebts();break;case`clients`:renderClients();break;case`employees`:ze();break;case`expenses`:renderExpenses();break;case`calculations`:renderCalculations();break;case`admin`:renderAdmin();break;case`profile`:Vr();break;case`bulk-delete`:renderBulkDelete();break;case`mp-stats`:renderMpStats();break;case`mp-categories`:renderMpCategories();break;case`mp-products`:renderMpProducts();break;case`mp-sales`:renderMpSales();break;case`mp-orders`:renderMpOrders();break;default:f.innerHTML=`<div class="empty-state"><h4>${o(`Sahifa topilmadi`)}</h4></div>`}}async function Nr(){let e=d(),t=document.getElementById(`page-content`);try{let n,r,i;if(e){let t=new Date,a=`&startDate=${new Date(t.getFullYear(),t.getMonth()-1,1).toISOString().split(`T`)[0]}&endDate=${t.toISOString().split(`T`)[0]}`;[n,r,i]=await Promise.all([s.get(`/products?businessId=${e}`).catch(()=>[]),s.get(`/transactions?businessId=${e}${a}`).catch(()=>[]),s.get(`/clients?businessId=${e}`).catch(()=>[])])}else{let e=await s.get(`/businesses/my`).catch(()=>[]),a=s.getUser();if(!e||e.length===0){t.innerHTML=`
          ...
          </div>`;return}let c=new Date,l=`&startDate=${new Date(c.getFullYear(),c.getMonth()-1,1).toISOString().split(`T`)[0]}&endDate=${c.toISOString().split(`T`)[0]}`,u=await Promise.all(e.map(e=>s.get(`/products?businessId=${e.id}`).catch(()=>[]))),d=await Promise.all(e.map(e=>s.get(`/transactions?businessId=${e.id}${l}`).catch(()=>[]))),f=await Promise.all(e.map(e=>s.get(`/clients?businessId=${e.id}`).catch(()=>[])));n=u.flat(),r=d.flat(),i=f.flat()}let a=(n||[]).filter(e=>e&&!e.isDeleted),l=(r||[]).filter(e=>e).sort((e,t)=>new Date(t.createdAt)-new Date(e.createdAt)),u=(i||[]).filter(e=>e),d=new Date,f=d.toISOString().split(`T`)[0],p=d.getMonth(),m=d.getFullYear(),h=l.filter(e=>{let t=new Date(e.createdAt);return t.getMonth()===p&&t.getFullYear()===m}).reduce((e,t)=>e+(t.total||0),0),g=p===0?11:p-1,_=p===0?m-1:m,v=l.filter(e=>{let t=new Date(e.createdAt);return t.getMonth()===g&&t.getFullYear()===_}).reduce((e,t)=>e+(t.total||0),0),y=d.getDate(),b=l.filter(e=>{let t=new Date(e.createdAt);return t.getMonth()===g&&t.getFullYear()===_&&t.getDate()<=y}).reduce((e,t)=>e+(t.total||0),0),x=0,S=`none`;v>0?(x=(h-v)/v*100,S=x>=0?`up`:`down`):h>0&&(S=`up`,x=100);let C=0,w=`none`;b>0?(C=(h-b)/b*100,w=C>=0?`up`:`down`):h>0&&(w=`up`,C=100);let T=w===`down`?`trending-down`:`trending-up`,ee=w===`down`?`var(--danger)`:`var(--success)`,E=w===`down`?`var(--danger-bg)`:`var(--success-bg)`,D=u.filter(e=>{let t=new Date(e.createdAt);return t.getMonth()===p&&t.getFullYear()===m}).length,O=o([`Yanvar`,`Fevral`,`Mart`,`Aprel`,`May`,`Iyun`,`Iyul`,`Avgust`,`Sentabr`,`Oktabr`,`Noyabr`,`Dekabr`][p]),te=l.filter(e=>e.createdAt.startsWith(f)).length,ne=a.filter(e=>(e.quantity||0)<=(e.minQuantity||5)).length,re=a.length>0?Math.round((a.length-ne)/a.length*100):100,ie=a.reduce((e,t)=>e+(t.quantity||0)*(t.price||0),0),ae=a.reduce((e,t)=>e+(t.quantity||0),0),oe=s.getUser();oe&&parseInt(oe.role)===0?t.innerHTML=`
        ...
        <div class="stats-grid fade-in">
          <div class="stat-card">
            ...
            <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-top:8px;">
              <div class="stat-trend" style="color:var(--text-muted); font-size:12px; font-weight:400;">${O}</div>
          ...
          <div class="stat-card">
            ...
            <div class="stat-trend" style="color:var(--success); font-size:12px; margin-top:8px;">
              ↑ ${te} <span style="color:var(--text-muted); font-weight:400;">${o(`bugun`)}</span>
            </div>
          </div>
      ...
      `,Lr=l,dashboardPage=1,Pr(a.slice(0,5)),Fr(a.slice(0,5)),Rr(),Dr=l,Or=a,setTimeout(()=>{typeof lucide<`u`&&lucide.createIcons(),Ir(Dr,Or)},100)}catch(e){console.error(e),t.innerHTML=`<div class="empty-state"><h4>${o(`Xatolik`)}</h4><p>${u(e.message)}</p></div>`}}function Pr(e){let t=document.getElementById(`dashboard-inventory-container`);if(!t)return;let n={};(e||[]).forEach(e=>{let t=e.categoryName||o(`Boshqa`);n[t]||(n[t]=[]),n[t].push(e)});let r=``;for(let e in n)r+=`
    ...
    `}function Fr(e){let t=document.getElementById(`top-products-list`);if(!t)return;let n=[`#3b82f6`,`#10b981`,`#f59e0b`,`#ef4444`,`#ec4899`];t.innerHTML=e.map((e,t)=>`
        <div style="display:flex; align-items:center; gap:12px;">
    ...
    `).join(``),setTimeout(()=>{(e||[]).forEach((e,t)=>{let r=document.getElementById(`mini-sparkline-${t}`);if(r){let e=Chart.getChart(r);e&&e.destroy(),new Chart(r,{type:`line`,data:{labels:[1,2,3,4,5],datasets:[{data:[10,15,12,18,14],borderColor:n[t%5],borderWidth:2,pointRadius:0,fill:!1,tension:.4}]},options:{plugins:{legend:{display:!1}},scales:{x:{display:!1},y:{display:!1}},maintainAspectRatio:!1}})}})},100)}function Ir(e,t){let n=document.getElementById(`salesTrendChart`);if(n){let e=n.getContext(`2d`),t=[o(`Dush`),o(`Sesh`),o(`Chor`),o(`Pay`),o(`Jum`),o(`Shan`),o(`Yak`)],r=[12,19,15,25,22,30,20],i=e.createLinearGradient(0,0,0,400);i.addColorStop(0,`rgba(16, 185, 129, 0.4)`),i.addColorStop(1,`rgba(16, 185, 129, 0)`);let a=Chart.getChart(n);a&&a.destroy(),new Chart(n,{type:kr,data:{labels:t,datasets:[{label:o(`Savdo hajmi`),data:r,borderColor:`#10b981`,borderWidth:4,fill:!0,backgroundColor:i,tension:.4,pointRadius:6,pointBackgroundColor:`#10b981`,pointBorderColor:`#fff`,pointBorderWidth:3,pointHoverRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,grid:{color:`rgba(255,255,255,0.05)`,drawBorder:!1},ticks:{color:`#64748b`,font:{size:10,family:`Plus Jakarta Sans`}}},x:{grid:{display:!1},ticks:{color:`#64748b`,font:{size:10,family:`Plus Jakarta Sans`}}}}}})}let r=document.getElementById(`salesSourceChart`);if(r){let t=e.reduce((e,t)=>e+(t.cash||0),0),n=e.reduce((e,t)=>e+(t.card||0),0),i=e.reduce((e,t)=>e+(t.click||0),0),a=e.reduce((e,t)=>e+(t.debt||0),0),s=t+n+i+a>0,l=s?[t,n,i,a]:[1],u=s?[o(`Naqd`),o(`Karta`),o(`Click`),o(`Qarz`)]:[o(`Ma'lumot yo'q`)],d=s?[`#10b981`,`#3b82f6`,`#8b5cf6`,`#ef4444`]:[`rgba(100, 116, 139, 0.2)`],f=Chart.getChart(r);f&&f.destroy(),new Chart(r,{type:`pie`,data:{labels:u,datasets:[{data:l,backgroundColor:d,borderWidth:s?2:0,borderColor:`var(--bg-card)`,hoverOffset:s?15:0}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{enabled:s,callbacks:{label:function(e){let t=e.label||``,n=e.raw||0,r=e.dataset.data.reduce((e,t)=>e+t,0),i=r>0?Math.round(n/r*100):0;return`${t}: ${c(n)} (${i}%)`}}}}}});let p=document.getElementById(`sales-sources-legend`);if(p){let e=s?t+n+i+a:0,r=[o(`Naqd`),o(`Karta`),o(`Click`),o(`Qarz`)],c=[`#10b981`,`#3b82f6`,`#8b5cf6`,`#ef4444`],l=[t,n,i,a];p.innerHTML=r.map((t,n)=>`
      ...
      `).join(``)}}}window.dashboardPage=1;var Lr=[];function Rr(){let t=document.getElementById(`dashboard-transactions-container`);if(!t)return;let n=Lr.slice(0,10),r=n.map((t,n)=>`
      <tr style="border-bottom: 1px solid var(--border);">
  ...
  `}function zr(e,t,n){return window[e]>=t?``:`<div id="${e}-sentinel" style="height:40px; margin:20px 0; display:flex; align-items:center; justify-content:center; color:var(--text-muted); font-size:13px; font-weight:500;">
    <div class="spinner-small" style="margin-right:10px;"></div> ${o(`Yuklanmoqda...`)}
  </div>`}window.attachInfiniteScroll=function(e,t,n,...r){let i=`${e}-sentinel`,a=document.getElementById(i);if(!a)return;let o=new IntersectionObserver(i=>{if(i[0].isIntersecting&&window[e]<t){window[e]++;let t=window[n];typeof t==`function`&&t.apply(null,[...r,!0]),o.disconnect()}},{threshold:.1,rootMargin:`150px`});o.observe(a)};var Br=!1;function Q(e,t,n=``,r=!1){let i=document.getElementById(`modal-body`),a=document.getElementById(`modal-overlay`);Br=r,i.className=`modal `+n,t?i.innerHTML=`
            <div class="modal-header">
                <h3>${e}</h3>
                <button class="modal-close" onclick="closeModal()">&times;</button>
            </div>
            <div class="modal-content">${t}</div>
        `:i.innerHTML=e,a.classList.add(`active`)}function $(e=!1){if(Br&&!e){s.logout(`org_required`);return}document.getElementById(`modal-overlay`).classList.remove(`active`),Br=!1}window.api=s,window.t=o,window.currentLang=l;async function Vr(){let t=document.getElementById(`page-content`),n=s.getUser();if(!n)return;try{let e=await s.get(`/users/${n.id}`);s.setUser(e)}catch(e){console.error(`User info refresh error:`,e)}let r=s.getUser();t.innerHTML=`
    ...
    </div>`}function Hr(){let e=s.getUser();Q(o(`Profilni tahrirlash`),`
    ...
    `)}window.clearProfileImage=function(){document.getElementById(`edit-image-url`).value=``,document.getElementById(`profile-image-preview`).innerHTML=`<span style="font-size:24px; opacity:0.3;">🖼️</span>`},window.clearBrandImage=function(){document.getElementById(`edit-brandImage-url`).value=``,document.getElementById(`brand-image-preview`).innerHTML=`<span style="font-size:24px; opacity:0.3;">🖼️</span>`},window.generateTelegramLink=async function(){try{a(o(`Havola yaratilmoqda...`),`info`);let e=await s.post(`/users/telegram-link`,{});if(e&&e.link){let t=`https://t.me/${e.botUserName||`savdosklad_bot`}?start=${e.link}`,n=document.createElement(`div`);n.id=`tg-link-popup`,n.style.cssText=`position:fixed; inset:0; background:rgba(0,0,0,0.6); z-index:9999; display:flex; align-items:center; justify-content:center;`,n.innerHTML=`
            ...
            `,document.body.appendChild(n)}}catch(e){a(e.message||o(`Xatolik`),`error`)}};async function Ur(e){if(e.files&&e.files[0]){let t=e.files[0],n=new FormData;n.append(`file`,t);try{a(o(`Rasm yuklanmoqda...`),`info`);let e=await s.post(`/upload`,n);e&&e.url&&(document.getElementById(`edit-image-url`).value=e.url,document.getElementById(`profile-image-preview`).innerHTML=`<img src="${e.url}" style="width:100%; height:100%; object-fit:cover;">`,a(o(`Rasm yuklandi`)))}catch(e){a(e.message,`error`)}}}async function Wr(e){if(e.files&&e.files[0]){let t=e.files[0],n=new FormData;n.append(`file`,t);try{a(o(`Rasm yuklanmoqda...`),`info`);let e=await s.post(`/upload`,n);e&&e.url&&(document.getElementById(`edit-brandImage-url`).value=e.url,document.getElementById(`brand-image-preview`).innerHTML=`<img src="${e.url}" style="width:100%; height:100%; object-fit:cover;">`,a(o(`Brend rasmi yuklandi`)))}catch(e){a(e.message,`error`)}}}async function Gr(e){e.preventDefault();let t=s.getUser(),n={firstName:document.getElementById(`edit-firstName`).value,lastName:document.getElementById(`edit-lastName`).value,phoneNumber:document.getElementById(`edit-phone`).value,image:document.getElementById(`edit-image-url`).value};t.role>=1&&(n.brandName=document.getElementById(`edit-brandName`).value,n.brandImage=document.getElementById(`edit-brandImage-url`).value);try{await s.put(`/users/${t.id}`,n);let e={...t,...n};s.setUser(e),a(o(`Profil yangilandi`)),$(),Ar(),Vr()}catch(e){a(e.message,`error`)}}function Kr(){Q(o(`Parolni o'zgartirish`),`
    ...
    `)}async function qr(e){e.preventDefault();let t=s.getUser(),n=document.getElementById(`new-password`).value;if(n!==document.getElementById(`confirm-password`).value)return a(o(`Parollar bir xil emas`),`error`);try{await s.put(`/users/${t.id}`,{password:n}),a(o(`Parol yangilandi`)),$()}catch(e){a(e.message,`error`)}}function Jr(e){e&&navigator.clipboard.writeText(e).then(()=>{a(o(`Nusxa olindi`))}).catch(e=>{a(o(`Xatolik: `)+e,`error`)})}window.navigateTo=Z,window.onBusinessChange=Mr,window.renderProfile=Vr,window.showEditProfileModal=Hr,window.handleUpdateProfile=Gr,window.previewProfileImage=Ur,window.previewBrandImage=Wr,window.showChangePasswordModal=Kr,window.handleChangePassword=qr,window.copyToClipboard=Jr,window.toggleTheme=n,window.updateThemeIcon=r,window.currentPage=Er,window.dashboardPage=dashboardPage,window.navigateTo=Z,window.renderPageControls=zr,window.renderDashboard=Nr,window.openModal=Q,window.closeModal=$,window.onBusinessChange=Mr,window.renderDashboardTransactions=Rr,window.closeModalOnOverlay=function(e){},window.maximizeTrendChart=function(){Q(o(`Oylik savdo ko'rsatkichi`),`
        <div style="height:600px; width:100%;">
            <canvas id="maxSalesChart"></canvas>
        </div>
    `,`modal-xl`),setTimeout(()=>{let e=document.getElementById(`maxSalesChart`)?.getContext(`2d`);if(e){let t=[o(`Dush`),o(`Sesh`),o(`Chor`),o(`Pay`),o(`Jum`),o(`Shan`),o(`Yak`)];new Chart(e,{type:kr,data:{labels:t,datasets:[{label:o(`Savdo hajmi`),data:[12,19,15,25,22,30,20],borderColor:`#10b981`,borderWidth:4,fill:!0,backgroundColor:`rgba(16, 185, 129, 0.1)`,tension:.4,pointRadius:6,pointBackgroundColor:`#10b981`}]},options:{responsive:!0,maintainAspectRatio:!1}})}},200)},window.openTrendChartSettings=function(){Q(o(`Grafik sozlamalari`),`
        <div style="padding:10px;">
            <div style="margin-bottom:20px;">
                <label style="display:block; margin-bottom:10px; color:var(--text-secondary);">${o(`Grafik turi`)}</label>
                <div style="display:flex; gap:10px;">
                    <button class="btn ${kr===`line`?`btn-primary`:`btn-secondary`}" style="flex:1;" onclick="setChartType('line')">
                        <i data-lucide="line-chart"></i> ${o(`Chiziqli`)}
                    </button>
                    <button class="btn ${kr===`bar`?`btn-primary`:`btn-secondary`}" style="flex:1;" onclick="setChartType('bar')">
    ...
    `),setTimeout(()=>{typeof lucide<`u`&&lucide.createIcons()},50)},window.setChartType=function(e){kr=e,$(),Ir(Dr,Or),a(o(`Grafik turi yangilandi`),`success`)},window.toggleSidebar=function(){let e=document.querySelector(`.sidebar`),t=document.querySelector(`.dashboard`),n=document.querySelector(`.sidebar-logo .btn-icon .icon`);if(e){if(window.innerWidth<=1024){e.classList.toggle(`mobile-open`);return}e&&t&&(e.classList.toggle(`collapsed`),t.classList.toggle(`sidebar-collapsed`),e.classList.contains(`collapsed`)?(n&&(n.textContent=`▶`),localStorage.setItem(`sidebarCollapsed`,`true`)):(n&&(n.textContent=`◀`),localStorage.setItem(`sidebarCollapsed`,`false`)))}},document.addEventListener(`DOMContentLoaded`,()=>{if(localStorage.getItem(`sidebarCollapsed`)===`true`){let e=document.querySelector(`.sidebar`),t=document.querySelector(`.dashboard`),n=document.querySelector(`.sidebar-logo .btn-icon .icon`);e&&t&&(e.classList.add(`collapsed`),t.classList.add(`sidebar-collapsed`),n&&(n.textContent=`▶`))}}),document.addEventListener(`DOMContentLoaded`,()=>{let e=document.createElement(`style`);e.textContent=`
  ...
  `)},window.applyDateFilter=function(){let e=document.getElementById(`filter-start-date`).value,t=document.getElementById(`filter-end-date`).value;if(!e||!t){a(o(`Sanalarni to'liq tanlang`),`warning`);return}setDatePeriod(e,t),$(),Z(window.currentPage)},window.resetDateFilter=function(){clearDatePeriod(),$(),Z(window.currentPage)},window.renderBulkDelete=async function(){let e=d(),t=s.getUser(),n=(t?parseInt(t.role):0)>=2;if(!n&&!e){document.getElementById(`page-content`).innerHTML=`
        ...
        `;return}n?Yr():Xr()};async function Yr(){let t=document.getElementById(`page-content`);t.innerHTML=`
